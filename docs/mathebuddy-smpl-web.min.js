...
`,this.token.type=le.LexerTokenType.DEL;else if(this.putTrailingSemicolon.length>0){let t=!1;for(let i of this.putTrailingSemicolon)if(i.type===this.lastToken.type&&(i.type===le.LexerTokenType.DEL?t=i.token===this.lastToken.token:t=!0,t))break;t&&(r=!0,this.token.row=e.row,this.token.col=e.col,this.token.token=";",this.token.type=le.LexerTokenType.DEL)}return e.row++,e.col=1,e.indent=0,e.i++,this.emitNewline||r}isNext(e){let r=this.fileStack.slice(-1)[0].sourceCode,t=this.state,i=e.length;if(t.i+i>=t.n)return!1;for(let a=0;a<i;a++){let l=e[a];if(r[t.i+a]!=l)return!1}return!0}pushSource(e,r){this.fileStack.length>0&&(this.fileStack.slice(-1)[0].stateBackup=this.state.copy(),this.fileStack.slice(-1)[0].tokenBackup=this.token.copy());let t=new Kt;t.id=e,t.sourceCode=r,this.fileStack.push(t),this.state=new Rf.LexerState,this.state.n=r.length,this.next()}popSource(){this.fileStack.pop(),this.fileStack.length>0&&(this.state=this.fileStack.slice(-1)[0].stateBackup,this.token=this.fileStack.slice(-1)[0].tokenBackup)}backupState(){return{state:this.state.copy(),token:this.token.copy()}}replayState(e){this.state=e.state,this.token=e.token}};Qr.Lexer=ti});var ni=Zr(tt=>{"use strict";var If=tt&&tt.__createBinding||(Object.create?function(n,e,r,t){t===void 0&&(t=r);var i=Object.getOwnPropertyDescriptor(e,r);(!i||("get"in i?!e.__esModule:i.writable||i.configurable))&&(i={enumerable:!0,get:function(){return e[r]}}),Object.defineProperty(n,t,i)}:function(n,e,r,t){t===void 0&&(t=r),n[t]=e[r]}),Lf=tt&&tt.__exportStar||function(n,e){for(var r in n)r!=="default"&&!Object.prototype.hasOwnProperty.call(e,r)&&If(e,n,r)};Object.defineProperty(tt,"__esModule",{value:!0});Lf(so(),tt)});var ko=Zr((oi,ui)=>{(function(n,e){typeof oi=="object"&&typeof ui<"u"?ui.exports=e():typeof define=="function"&&define.amd?define(e):(n=typeof globalThis<"u"?globalThis:n||self,n.typed=e())})(oi,function(){"use strict";function n(o,s){var p=typeof Symbol<"u"&&o[Symbol.iterator]||o["@@iterator"];if(!p){if(Array.isArray(o)||(p=e(o))||s&&o&&typeof o.length=="number"){p&&(o=p);var h=0,v=function(){};return{s:v,n:function(){return h>=o.length?{done:!0}:{done:!1,value:o[h++]}},e:function(D){throw D},f:v}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var m=!0,d=!1,g;return{s:function(){p=p.call(o)},n:function(){var D=p.next();return m=D.done,D},e:function(D){d=!0,g=D},f:function(){try{!m&&p.return!=null&&p.return()}finally{if(d)throw g}}}}function e(o,s){if(!!o){if(typeof o=="string")return r(o,s);var p=Object.prototype.toString.call(o).slice(8,-1);if(p==="Object"&&o.constructor&&(p=o.constructor.name),p==="Map"||p==="Set")return Array.from(o);if(p==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(p))return r(o,s)}}function r(o,s){(s==null||s>o.length)&&(s=o.length);for(var p=0,h=new Array(s);p<s;p++)h[p]=o[p];return h}function t(o){return t=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(s){return typeof s}:function(s){return s&&typeof Symbol=="function"&&s.constructor===Symbol&&s!==Symbol.prototype?"symbol":typeof s},t(o)}function i(){return!0}function a(){return!1}function l(){}var c="Argument is not a typed-function.";function f(){function o(S){return t(S)==="object"&&S!==null&&S.constructor===Object}var s=[{name:"number",test:function(I){return typeof I=="number"}},{name:"string",test:function(I){return typeof I=="string"}},{name:"boolean",test:function(I){return typeof I=="boolean"}},{name:"Function",test:function(I){return typeof I=="function"}},{name:"Array",test:Array.isArray},{name:"Date",test:function(I){return I instanceof Date}},{name:"RegExp",test:function(I){return I instanceof RegExp}},{name:"Object",test:o},{name:"null",test:function(I){return I===null}},{name:"undefined",test:function(I){return I===void 0}}],p={name:"any",test:i,isAny:!0},h,v,m=0,d={createCount:0};function g(S){var I=h.get(S);if(I)return I;var k='Unknown type "'+S+'"',Y=S.toLowerCase(),K,j=n(v),te;try{for(j.s();!(te=j.n()).done;)if(K=te.value,K.toLowerCase()===Y){k+='. Did you mean "'+K+'" ?';break}}catch(J){j.e(J)}finally{j.f()}throw new TypeError(k)}function y(S){for(var I=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"any",k=I?g(I).index:v.length,Y=[],K=0;K<S.length;++K){if(!S[K]||typeof S[K].name!="string"||typeof S[K].test!="function")throw new TypeError("Object with properties {name: string, test: function} expected");var j=S[K].name;if(h.has(j))throw new TypeError('Duplicate type name "'+j+'"');Y.push(j),h.set(j,{name:j,test:S[K].test,isAny:S[K].isAny,index:k+K,conversionsTo:[]})}var te=v.slice(k);v=v.slice(0,k).concat(Y).concat(te);for(var J=k+Y.length;J<v.length;++J)h.get(v[J]).index=J}function D(){h=new Map,v=[],m=0,y([p],!1)}D(),y(s);function w(){var S,I=n(v),k;try{for(I.s();!(k=I.n()).done;)S=k.value,h.get(S).conversionsTo=[]}catch(Y){I.e(Y)}finally{I.f()}m=0}function b(S){var I=v.filter(function(k){var Y=h.get(k);return!Y.isAny&&Y.test(S)});return I.length?I:["any"]}function x(S){return S&&typeof S=="function"&&"_typedFunctionData"in S}function A(S,I,k){if(!x(S))throw new TypeError(c);var Y=k&&k.exact,K=Array.isArray(I)?I.join(","):I,j=O(K),te=E(j);if(!Y||te in S.signatures){var J=S._typedFunctionData.signatureMap.get(te);if(J)return J}var ee=j.length,me;if(Y){me=[];var Ae;for(Ae in S.signatures)me.push(S._typedFunctionData.signatureMap.get(Ae))}else me=S._typedFunctionData.signatures;for(var ie=0;ie<ee;++ie){var ir=j[ie],$e=[],rr=void 0,Xe=n(me),lr;try{for(Xe.s();!(lr=Xe.n()).done;){rr=lr.value;var Qe=V(rr.params,ie);if(!(!Qe||ir.restParam&&!Qe.restParam)){if(!Qe.hasAny){var Dr=function(){var cr=L(Qe);if(ir.types.some(function(et){return!cr.has(et.name)}))return"continue"}();if(Dr==="continue")continue}$e.push(rr)}}}catch(cr){Xe.e(cr)}finally{Xe.f()}if(me=$e,me.length===0)break}var ar,or=n(me),jr;try{for(or.s();!(jr=or.n()).done;)if(ar=jr.value,ar.params.length<=ee)return ar}catch(cr){or.e(cr)}finally{or.f()}throw new TypeError("Signature not found (signature: "+(S.name||"unnamed")+"("+E(j,", ")+"))")}function _(S,I,k){return A(S,I,k).implementation}function C(S,I){var k=g(I);if(k.test(S))return S;var Y=k.conversionsTo;if(Y.length===0)throw new Error("There are no conversions to "+I+" defined.");for(var K=0;K<Y.length;K++){var j=g(Y[K].from);if(j.test(S))return Y[K].convert(S)}throw new Error("Cannot convert "+S+" to "+I)}function E(S){var I=arguments.length>1&&arguments[1]!==void 0?arguments[1]:",";return S.map(function(k){return k.name}).join(I)}function T(S){var I=S.indexOf("...")===0,k=I?S.length>3?S.slice(3):"any":S,Y=k.split("|").map(function(J){return g(J.trim())}),K=!1,j=I?"...":"",te=Y.map(function(J){return K=J.isAny||K,j+=J.name+"|",{name:J.name,typeIndex:J.index,test:J.test,isAny:J.isAny,conversion:null,conversionIndex:-1}});return{types:te,name:j.slice(0,-1),hasAny:K,hasConversion:!1,restParam:I}}function M(S){var I=S.types.map(function(te){return te.name}),k=W(I),Y=S.hasAny,K=S.name,j=k.map(function(te){var J=g(te.from);return Y=J.isAny||Y,K+="|"+te.from,{name:te.from,typeIndex:J.index,test:J.test,isAny:J.isAny,conversion:te,conversionIndex:te.index}});return{types:S.types.concat(j),name:K,hasAny:Y,hasConversion:j.length>0,restParam:S.restParam}}function L(S){return S.typeSet||(S.typeSet=new Set,S.types.forEach(function(I){return S.typeSet.add(I.name)})),S.typeSet}function O(S){var I=[];if(typeof S!="string")throw new TypeError("Signatures must be strings");var k=S.trim();if(k==="")return I;for(var Y=k.split(","),K=0;K<Y.length;++K){var j=T(Y[K].trim());if(j.restParam&&K!==Y.length-1)throw new SyntaxError('Unexpected rest parameter "'+Y[K]+'": only allowed for the last parameter');if(j.types.length===0)return null;I.push(j)}return I}function R(S){var I=ye(S);return I?I.restParam:!1}function N(S){if(!S||S.types.length===0)return i;if(S.types.length===1)return g(S.types[0].name).test;if(S.types.length===2){var I=g(S.types[0].name).test,k=g(S.types[1].name).test;return function(j){return I(j)||k(j)}}else{var Y=S.types.map(function(K){return g(K.name).test});return function(j){for(var te=0;te<Y.length;te++)if(Y[te](j))return!0;return!1}}}function X(S){var I,k,Y;if(R(S)){I=fe(S).map(N);var K=I.length,j=N(ye(S)),te=function(ee){for(var me=K;me<ee.length;me++)if(!j(ee[me]))return!1;return!0};return function(ee){for(var me=0;me<I.length;me++)if(!I[me](ee[me]))return!1;return te(ee)&&ee.length>=K+1}}else return S.length===0?function(ee){return ee.length===0}:S.length===1?(k=N(S[0]),function(ee){return k(ee[0])&&ee.length===1}):S.length===2?(k=N(S[0]),Y=N(S[1]),function(ee){return k(ee[0])&&Y(ee[1])&&ee.length===2}):(I=S.map(N),function(ee){for(var me=0;me<I.length;me++)if(!I[me](ee[me]))return!1;return ee.length===I.length})}function V(S,I){return I<S.length?S[I]:R(S)?ye(S):null}function F(S,I){var k=V(S,I);return k?L(k):new Set}function B(S){return S.conversion===null||S.conversion===void 0}function q(S,I){var k=new Set;return S.forEach(function(Y){var K=F(Y.params,I),j,te=n(K),J;try{for(te.s();!(J=te.n()).done;)j=J.value,k.add(j)}catch(ee){te.e(ee)}finally{te.f()}}),k.has("any")?["any"]:Array.from(k)}function H(S,I,k){var Y,K,j=S||"unnamed",te=k,J,ee=function(){var Xe=[];if(te.forEach(function(Qe){var Dr=V(Qe.params,J),ar=N(Dr);(J<Qe.params.length||R(Qe.params))&&ar(I[J])&&Xe.push(Qe)}),Xe.length===0){if(K=q(te,J),K.length>0){var lr=b(I[J]);return Y=new TypeError("Unexpected type of argument in function "+j+" (expected: "+K.join(" or ")+", actual: "+lr.join(" | ")+", index: "+J+")"),Y.data={category:"wrongType",fn:j,index:J,actual:lr,expected:K},{v:Y}}}else te=Xe};for(J=0;J<I.length;J++){var me=ee();if(t(me)==="object")return me.v}var Ae=te.map(function(rr){return R(rr.params)?1/0:rr.params.length});if(I.length<Math.min.apply(null,Ae))return K=q(te,J),Y=new TypeError("Too few arguments in function "+j+" (expected: "+K.join(" or ")+", index: "+I.length+")"),Y.data={category:"tooFewArgs",fn:j,index:I.length,expected:K},Y;var ie=Math.max.apply(null,Ae);if(I.length>ie)return Y=new TypeError("Too many arguments in function "+j+" (expected: "+ie+", actual: "+I.length+")"),Y.data={category:"tooManyArgs",fn:j,index:I.length,expectedLength:ie},Y;for(var ir=[],$e=0;$e<I.length;++$e)ir.push(b(I[$e]).join("|"));return Y=new TypeError('Arguments of type "'+ir.join(", ")+'" do not match any of the defined signatures of function '+j+"."),Y.data={category:"mismatch",actual:ir},Y}function U(S){for(var I=v.length+1,k=0;k<S.types.length;k++)B(S.types[k])&&(I=Math.min(I,S.types[k].typeIndex));return I}function z(S){for(var I=m+1,k=0;k<S.types.length;k++)B(S.types[k])||(I=Math.min(I,S.types[k].conversionIndex));return I}function Z(S,I){if(S.hasAny){if(!I.hasAny)return 1}else if(I.hasAny)return-1;if(S.restParam){if(!I.restParam)return 1}else if(I.restParam)return-1;if(S.hasConversion){if(!I.hasConversion)return 1}else if(I.hasConversion)return-1;var k=U(S)-U(I);if(k<0)return-1;if(k>0)return 1;var Y=z(S)-z(I);return Y<0?-1:Y>0?1:0}function G(S,I){var k=S.params,Y=I.params,K=ye(k),j=ye(Y),te=R(k),J=R(Y);if(te&&K.hasAny){if(!J||!j.hasAny)return 1}else if(J&&j.hasAny)return-1;var ee=0,me=0,Ae,ie=n(k),ir;try{for(ie.s();!(ir=ie.n()).done;)Ae=ir.value,Ae.hasAny&&++ee,Ae.hasConversion&&++me}catch(At){ie.e(At)}finally{ie.f()}var $e=0,rr=0,Xe=n(Y),lr;try{for(Xe.s();!(lr=Xe.n()).done;)Ae=lr.value,Ae.hasAny&&++$e,Ae.hasConversion&&++rr}catch(At){Xe.e(At)}finally{Xe.f()}if(ee!==$e)return ee-$e;if(te&&K.hasConversion){if(!J||!j.hasConversion)return 1}else if(J&&j.hasConversion)return-1;if(me!==rr)return me-rr;if(te){if(!J)return 1}else if(J)return-1;var Qe=(k.length-Y.length)*(te?-1:1);if(Qe!==0)return Qe;for(var Dr=[],ar=0,or=0;or<k.length;++or){var jr=Z(k[or],Y[or]);Dr.push(jr),ar+=jr}if(ar!==0)return ar;for(var cr,et=0,Gt=Dr;et<Gt.length;et++)if(cr=Gt[et],cr!==0)return cr;return 0}function W(S){if(S.length===0)return[];var I=S.map(g);S.length>1&&I.sort(function(ee,me){return ee.index-me.index});var k=I[0].conversionsTo;if(S.length===1)return k;k=k.concat([]);for(var Y=new Set(S),K=1;K<I.length;++K){var j=void 0,te=n(I[K].conversionsTo),J;try{for(te.s();!(J=te.n()).done;)j=J.value,Y.has(j.from)||(k.push(j),Y.add(j.from))}catch(ee){te.e(ee)}finally{te.f()}}return k}function re(S,I){var k=I;if(S.some(function(J){return J.hasConversion})){var Y=R(S),K=S.map(ne);k=function(){for(var ee=[],me=Y?arguments.length-1:arguments.length,Ae=0;Ae<me;Ae++)ee[Ae]=K[Ae](arguments[Ae]);return Y&&(ee[me]=arguments[me].map(K[me])),I.apply(this,ee)}}var j=k;if(R(S)){var te=S.length-1;j=function(){return k.apply(this,Se(arguments,0,te).concat([Se(arguments,te)]))}}return j}function ne(S){var I,k,Y,K,j=[],te=[];switch(S.types.forEach(function(J){J.conversion&&(j.push(g(J.conversion.from).test),te.push(J.conversion.convert))}),te.length){case 0:return function(ee){return ee};case 1:return I=j[0],Y=te[0],function(ee){return I(ee)?Y(ee):ee};case 2:return I=j[0],k=j[1],Y=te[0],K=te[1],function(ee){return I(ee)?Y(ee):k(ee)?K(ee):ee};default:return function(ee){for(var me=0;me<te.length;me++)if(j[me](ee))return te[me](ee);return ee}}}function Q(S){function I(k,Y,K){if(Y<k.length){var j=k[Y],te=[];if(j.restParam){var J=j.types.filter(B);J.length<j.types.length&&te.push({types:J,name:"..."+J.map(function(ee){return ee.name}).join("|"),hasAny:J.some(function(ee){return ee.isAny}),hasConversion:!1,restParam:!0}),te.push(j)}else te=j.types.map(function(ee){return{types:[ee],name:ee.name,hasAny:ee.isAny,hasConversion:ee.conversion,restParam:!1}});return Ue(te,function(ee){return I(k,Y+1,K.concat([ee]))})}else return[K]}return I(S,0,[])}function ge(S,I){for(var k=Math.max(S.length,I.length),Y=0;Y<k;Y++){var K=F(S,Y),j=F(I,Y),te=!1,J=void 0,ee=n(j),me;try{for(ee.s();!(me=ee.n()).done;)if(J=me.value,K.has(J)){te=!0;break}}catch(rr){ee.e(rr)}finally{ee.f()}if(!te)return!1}var Ae=S.length,ie=I.length,ir=R(S),$e=R(I);return ir?$e?Ae===ie:ie>=Ae:$e?Ae>=ie:Ae===ie}function pe(S){return S.map(function(I){return Pr(I)?er(I.referToSelf.callback):Sr(I)?gr(I.referTo.references,I.referTo.callback):I})}function ae(S,I,k){var Y=[],K,j=n(S),te;try{for(j.s();!(te=j.n()).done;){K=te.value;var J=k[K];if(typeof J!="number")throw new TypeError('No definition for referenced signature "'+K+'"');if(J=I[J],typeof J!="function")return!1;Y.push(J)}}catch(ee){j.e(ee)}finally{j.f()}return Y}function ue(S,I,k){for(var Y=pe(S),K=new Array(Y.length).fill(!1),j=!0;j;){j=!1;for(var te=!0,J=0;J<Y.length;++J)if(!K[J]){var ee=Y[J];if(Pr(ee))Y[J]=ee.referToSelf.callback(k),Y[J].referToSelf=ee.referToSelf,K[J]=!0,te=!1;else if(Sr(ee)){var me=ae(ee.referTo.references,Y,I);me?(Y[J]=ee.referTo.callback.apply(this,me),Y[J].referTo=ee.referTo,K[J]=!0,te=!1):j=!0}}if(te&&j)throw new SyntaxError("Circular reference detected in resolving typed.referTo")}return Y}function De(S){var I=/\bthis(\(|\.signatures\b)/;Object.keys(S).forEach(function(k){var Y=S[k];if(I.test(Y.toString()))throw new SyntaxError("Using `this` to self-reference a function is deprecated since typed-function@3. Use typed.referTo and typed.referToSelf instead.")})}function be(S,I){if(d.createCount++,Object.keys(I).length===0)throw new SyntaxError("No signatures provided");d.warnAgainstDeprecatedThis&&De(I);var k=[],Y=[],K={},j=[],te,J=function(){if(!Object.prototype.hasOwnProperty.call(I,te))return"continue";var Je=O(te);if(!Je)return"continue";k.forEach(function(ot){if(ge(ot,Je))throw new TypeError('Conflicting signatures "'+E(ot)+'" and "'+E(Je)+'".')}),k.push(Je);var ja=Y.length;Y.push(I[te]);var bf=Je.map(M),Yt=void 0,$t=n(Q(bf)),eo;try{for($t.s();!(eo=$t.n()).done;){Yt=eo.value;var ro=E(Yt);j.push({params:Yt,name:ro,fn:ja}),Yt.every(function(ot){return!ot.hasConversion})&&(K[ro]=ja)}}catch(ot){$t.e(ot)}finally{$t.f()}};for(te in I)var ee=J();j.sort(G);var me=ue(Y,K,_t),Ae;for(Ae in K)Object.prototype.hasOwnProperty.call(K,Ae)&&(K[Ae]=me[K[Ae]]);for(var ie=[],ir=new Map,$e=0,rr=j;$e<rr.length;$e++)Ae=rr[$e],ir.has(Ae.name)||(Ae.fn=me[Ae.fn],ie.push(Ae),ir.set(Ae.name,Ae));for(var Xe=ie[0]&&ie[0].params.length<=2&&!R(ie[0].params),lr=ie[1]&&ie[1].params.length<=2&&!R(ie[1].params),Qe=ie[2]&&ie[2].params.length<=2&&!R(ie[2].params),Dr=ie[3]&&ie[3].params.length<=2&&!R(ie[3].params),ar=ie[4]&&ie[4].params.length<=2&&!R(ie[4].params),or=ie[5]&&ie[5].params.length<=2&&!R(ie[5].params),jr=Xe&&lr&&Qe&&Dr&&ar&&or,cr=0;cr<ie.length;++cr)ie[cr].test=X(ie[cr].params);for(var et=Xe?N(ie[0].params[0]):a,Gt=lr?N(ie[1].params[0]):a,At=Qe?N(ie[2].params[0]):a,Hs=Dr?N(ie[3].params[0]):a,Ws=ar?N(ie[4].params[0]):a,Ks=or?N(ie[5].params[0]):a,js=Xe?N(ie[0].params[1]):a,ef=lr?N(ie[1].params[1]):a,rf=Qe?N(ie[2].params[1]):a,tf=Dr?N(ie[3].params[1]):a,nf=ar?N(ie[4].params[1]):a,af=or?N(ie[5].params[1]):a,Ct=0;Ct<ie.length;++Ct)ie[Ct].implementation=re(ie[Ct].params,ie[Ct].fn);var of=Xe?ie[0].implementation:l,uf=lr?ie[1].implementation:l,sf=Qe?ie[2].implementation:l,ff=Dr?ie[3].implementation:l,lf=ar?ie[4].implementation:l,cf=or?ie[5].implementation:l,pf=Xe?ie[0].params.length:-1,mf=lr?ie[1].params.length:-1,hf=Qe?ie[2].params.length:-1,vf=Dr?ie[3].params.length:-1,df=ar?ie[4].params.length:-1,xf=or?ie[5].params.length:-1,gf=jr?6:0,Df=ie.length,yf=ie.map(function(dr){return dr.test}),Ef=ie.map(function(dr){return dr.implementation}),wf=function(){for(var Je=gf;Je<Df;Je++)if(yf[Je](arguments))return Ef[Je].apply(this,arguments);return d.onMismatch(S,arguments,ie)};function _t(dr,Je){return arguments.length===pf&&et(dr)&&js(Je)?of.apply(this,arguments):arguments.length===mf&&Gt(dr)&&ef(Je)?uf.apply(this,arguments):arguments.length===hf&&At(dr)&&rf(Je)?sf.apply(this,arguments):arguments.length===vf&&Hs(dr)&&tf(Je)?ff.apply(this,arguments):arguments.length===df&&Ws(dr)&&nf(Je)?lf.apply(this,arguments):arguments.length===xf&&Ks(dr)&&af(Je)?cf.apply(this,arguments):wf.apply(this,arguments)}try{Object.defineProperty(_t,"name",{value:S})}catch{}return _t.signatures=K,_t._typedFunctionData={signatures:ie,signatureMap:ir},_t}function Me(S,I,k){throw H(S,I,k)}function fe(S){return Se(S,0,S.length-1)}function ye(S){return S[S.length-1]}function Se(S,I,k){return Array.prototype.slice.call(S,I,k)}function Ve(S,I){for(var k=0;k<S.length;k++)if(I(S[k]))return S[k]}function Ue(S,I){return Array.prototype.concat.apply([],S.map(I))}function fr(){var S=fe(arguments).map(function(k){return E(O(k))}),I=ye(arguments);if(typeof I!="function")throw new TypeError("Callback function expected as last argument");return gr(S,I)}function gr(S,I){return{referTo:{references:S,callback:I}}}function er(S){if(typeof S!="function")throw new TypeError("Callback function expected as first argument");return{referToSelf:{callback:S}}}function Sr(S){return S&&t(S.referTo)==="object"&&Array.isArray(S.referTo.references)&&typeof S.referTo.callback=="function"}function Pr(S){return S&&t(S.referToSelf)==="object"&&typeof S.referToSelf.callback=="function"}function bt(S,I){if(!S)return I;if(I&&I!==S){var k=new Error("Function names do not match (expected: "+S+", actual: "+I+")");throw k.data={actual:I,expected:S},k}return S}function zr(S){var I;for(var k in S)Object.prototype.hasOwnProperty.call(S,k)&&(x(S[k])||typeof S[k].signature=="string")&&(I=bt(I,S[k].name));return I}function Qt(S,I){var k;for(k in I)if(Object.prototype.hasOwnProperty.call(I,k)){if(k in S&&I[k]!==S[k]){var Y=new Error('Signature "'+k+'" is defined twice');throw Y.data={signature:k,sourceFunction:I[k],destFunction:S[k]},Y}S[k]=I[k]}}var ei=d;d=function(I){for(var k=typeof I=="string",Y=k?1:0,K=k?I:"",j={},te=Y;te<arguments.length;++te){var J=arguments[te],ee={},me=void 0;if(typeof J=="function"?(me=J.name,typeof J.signature=="string"?ee[J.signature]=J:x(J)&&(ee=J.signatures)):o(J)&&(ee=J,k||(me=zr(J))),Object.keys(ee).length===0){var Ae=new TypeError("Argument to 'typed' at index "+te+" is not a (typed) function, nor an object with signatures as keys and functions as values.");throw Ae.data={index:te,argument:J},Ae}k||(K=bt(K,me)),Qt(j,ee)}return be(K||"",j)},d.create=f,d.createCount=ei.createCount,d.onMismatch=Me,d.throwMismatchError=Me,d.createError=H,d.clear=D,d.clearConversions=w,d.addTypes=y,d._findType=g,d.referTo=fr,d.referToSelf=er,d.convert=C,d.findSignature=A,d.find=_,d.isTypedFunction=x,d.warnAgainstDeprecatedThis=!0,d.addType=function(S,I){var k="any";I!==!1&&h.has("Object")&&(k="Object"),d.addTypes([S],k)};function at(S){if(!S||typeof S.from!="string"||typeof S.to!="string"||typeof S.convert!="function")throw new TypeError("Object with properties {from: string, to: string, convert: function} expected");if(S.to===S.from)throw new SyntaxError('Illegal to define conversion from "'+S.from+'" to itself.')}return d.addConversion=function(S){at(S);var I=g(S.to);if(I.conversionsTo.every(function(k){return k.from!==S.from}))I.conversionsTo.push({from:S.from,convert:S.convert,index:m++});else throw new Error('There is already a conversion from "'+S.from+'" to "'+I.name+'"')},d.addConversions=function(S){S.forEach(d.addConversion)},d.removeConversion=function(S){at(S);var I=g(S.to),k=Ve(I.conversionsTo,function(K){return K.from===S.from});if(!k)throw new Error("Attempt to remove nonexistent conversion from "+S.from+" to "+S.to);if(k.convert!==S.convert)throw new Error("Conversion to remove does not match existing conversion");var Y=I.conversionsTo.indexOf(k);I.conversionsTo.splice(Y,1)},d.resolve=function(S,I){if(!x(S))throw new TypeError(c);for(var k=S._typedFunctionData.signatures,Y=0;Y<k.length;++Y)if(k[Y].test(I))return k[Y];return null},d}var u=f();return u})});var Cu=Zr((Ci,Au)=>{(function(n){"use strict";var e=Math.cosh||function(u){return Math.abs(u)<1e-9?1-u:(Math.exp(u)+Math.exp(-u))*.5},r=Math.sinh||function(u){return Math.abs(u)<1e-9?u:(Math.exp(u)-Math.exp(-u))*.5},t=function(u){var o=Math.PI/4;if(-o>u||u>o)return Math.cos(u)-1;var s=u*u;return s*(s*(s*(s*(s*(s*(s*(s/20922789888e3-1/87178291200)+1/479001600)-1/3628800)+1/40320)-1/720)+1/24)-1/2)},i=function(u,o){var s=Math.abs(u),p=Math.abs(o);return s<3e3&&p<3e3?Math.sqrt(s*s+p*p):(s<p?(s=p,p=u/o):p=o/u,s*Math.sqrt(1+p*p))},a=function(){throw SyntaxError("Invalid Param")};function l(u,o){var s=Math.abs(u),p=Math.abs(o);return u===0?Math.log(p):o===0?Math.log(s):s<3e3&&p<3e3?Math.log(u*u+o*o)*.5:(u=u/2,o=o/2,.5*Math.log(u*u+o*o)+Math.LN2)}var c=function(u,o){var s={re:0,im:0};if(u==null)s.re=s.im=0;else if(o!==void 0)s.re=u,s.im=o;else switch(typeof u){case"object":if("im"in u&&"re"in u)s.re=u.re,s.im=u.im;else if("abs"in u&&"arg"in u){if(!Number.isFinite(u.abs)&&Number.isFinite(u.arg))return f.INFINITY;s.re=u.abs*Math.cos(u.arg),s.im=u.abs*Math.sin(u.arg)}else if("r"in u&&"phi"in u){if(!Number.isFinite(u.r)&&Number.isFinite(u.phi))return f.INFINITY;s.re=u.r*Math.cos(u.phi),s.im=u.r*Math.sin(u.phi)}else u.length===2?(s.re=u[0],s.im=u[1]):a();break;case"string":s.im=s.re=0;var p=u.match(/\d+\.?\d*e[+-]?\d+|\d+\.?\d*|\.\d+|./g),h=1,v=0;p===null&&a();for(var m=0;m<p.length;m++){var d=p[m];d===" "||d==="	"||d===`
