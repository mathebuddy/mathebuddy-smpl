...
`;)this.token.token+=e[t.i],t.i++,t.col++;if(t.i<t.n&&e[t.i]==='"'){t.i++,t.col++,this.state=t;return}}if(t=a.copy(),this.emitSingleQuotes&&(this.token.type=le.LexerTokenType.STR,t.i<t.n&&e[t.i]==="'")){for(this.token.token="",t.i++,t.col++;t.i<t.n&&e[t.i]!="'"&&e[t.i]!=`
...
U: `+this.U.toString()+`
P: `+this.p}}}});var ms="qr",fm=["typed","matrix","zeros","identity","isZero","equal","sign","sqrt","conj","unaryMinus","addScalar","divideScalar","multiplyScalar","subtract","complex"],La=P(ms,fm,n=>{var{typed:e,matrix:r,zeros:t,identity:i,isZero:a,equal:l,sign:c,sqrt:f,conj:u,unaryMinus:o,addScalar:s,divideScalar:p,multiplyScalar:h,subtract:v,complex:m}=n;return nt(e(ms,{DenseMatrix:function(w){return g(w)},SparseMatrix:function(w){return y(w)},Array:function(w){var b=r(w),x=g(b);return{Q:x.Q.valueOf(),R:x.R.valueOf()}}}),{_denseQRimpl:d});function d(D){var w=D._size[0],b=D._size[1],x=i([w],"dense"),A=x._data,_=D.clone(),C=_._data,E,T,M,L=t([w],"");for(M=0;M<Math.min(b,w);++M){var O=C[M][M],I=o(l(O,0)?1:c(O)),N=u(I),X=0;for(E=M;E<w;E++)X=s(X,h(C[E][M],u(C[E][M])));var V=h(I,f(X));if(!a(V)){var F=v(O,V);for(L[M]=1,E=M+1;E<w;E++)L[E]=p(C[E][M],F);var B=o(u(p(F,V))),q=void 0;for(T=M;T<b;T++){for(q=0,E=M;E<w;E++)q=s(q,h(u(L[E]),C[E][T]));for(q=h(q,B),E=M;E<w;E++)C[E][T]=h(v(C[E][T],h(L[E],q)),N)}for(E=0;E<w;E++){for(q=0,T=M;T<w;T++)q=s(q,h(A[E][T],L[T]));for(q=h(q,B),T=M;T<w;++T)A[E][T]=p(v(A[E][T],h(q,u(L[T]))),N)}}}return{Q:x,R:_,toString:function(){return"Q: "+this.Q.toString()+`
R: `+this.R.toString()}}}function g(D){var w=d(D),b=w.R._data;if(D._data.length>0)for(var x=b[0][0].type==="Complex"?m(0):0,A=0;A<b.length;++A)for(var _=0;_<A&&_<(b[0]||[]).length;++_)b[A][_]=x;return w}function y(D){throw new Error("qr not implemented for sparse matrices yet")}});function hs(n,e,r,t){for(var i=n._values,a=n._index,l=n._ptr,c=n._size,f=n._datatype,u=c[0],o=c[1],s=t&&n._values?[]:null,p=[],h=[],v=0,m=0;m<o;m++){h[m]=v;for(var d=r?r[m]:m,g=l[d],y=l[d+1],D=g;D<y;D++){var w=e?e[a[D]]:a[D];p[v]=w,s&&(s[v]=i[D]),v++}}return h[o]=v,n.createSparseMatrix({values:s,index:p,ptr:h,size:[u,o],datatype:f})}function On(n,e,r,t,i,a,l){var c=0;for(r[l]=n;c>=0;){var f=r[l+c],u=r[t+f];u===-1?(c--,a[e++]=f):(r[t+f]=r[i+u],++c,r[l+c]=u)}return e}function vs(n,e){if(!n)return null;var r=0,t,i=[],a=[],l=0,c=e,f=2*e;for(t=0;t<e;t++)a[l+t]=-1;for(t=e-1;t>=0;t--)n[t]!==-1&&(a[c+t]=a[l+n[t]],a[l+n[t]]=t);for(t=0;t<e;t++)n[t]===-1&&(r=On(t,r,a,l,c,i,f));return i}function ds(n,e){if(!n)return null;var r=n._index,t=n._ptr,i=n._size,a=i[0],l=i[1],c=[],f=[],u=0,o=l,s,p;if(e)for(s=0;s<a;s++)f[o+s]=-1;for(var h=0;h<l;h++){c[h]=-1,f[u+h]=-1;for(var v=t[h],m=t[h+1],d=v;d<m;d++){var g=r[d];for(s=e?f[o+g]:g;s!==-1&&s<h;s=p)p=f[u+s],f[u+s]=h,p===-1&&(c[s]=h);e&&(f[o+g]=h)}}return c}function xs(n,e,r){for(var t=n._values,i=n._index,a=n._ptr,l=n._size,c=l[1],f=0,u=0;u<c;u++){var o=a[u];for(a[u]=f;o<a[u+1];o++)e(i[o],u,t?t[o]:1,r)&&(i[f]=i[o],t&&(t[f]=t[o]),f++)}return a[c]=f,i.splice(f,i.length-f),t&&t.splice(f,t.length-f),f}function Mr(n){return-n-2}var lm="csAmd",cm=["add","multiply","transpose"],gs=P(lm,cm,n=>{var{add:e,multiply:r,transpose:t}=n;return function(o,s){if(!s||o<=0||o>3)return null;var p=s._size,h=p[0],v=p[1],m=0,d=Math.max(16,10*Math.sqrt(v));d=Math.min(v-2,d);var g=i(o,s,h,v,d);xs(g,f,null);for(var y=g._index,D=g._ptr,w=D[v],b=[],x=[],A=0,_=v+1,C=2*(v+1),E=3*(v+1),T=4*(v+1),M=5*(v+1),L=6*(v+1),O=7*(v+1),I=b,N=a(v,D,x,A,E,I,C,O,_,L,T,M),X=l(v,D,x,M,T,L,d,_,E,I,C),V=0,F,B,q,H,U,z,Z,G,W,re,ne,Q,ge,pe,ae,ue;X<v;){for(q=-1;V<v&&(q=x[E+V])===-1;V++);x[C+q]!==-1&&(I[x[C+q]]=-1),x[E+V]=x[C+q];var De=x[T+q],be=x[_+q];X+=be;var Me=0;x[_+q]=-be;var fe=D[q],ye=De===0?fe:w,Se=ye;for(H=1;H<=De+1;H++){for(H>De?(z=q,Z=fe,G=x[A+q]-De):(z=y[fe++],Z=D[z],G=x[A+z]),U=1;U<=G;U++)F=y[Z++],!((W=x[_+F])<=0)&&(Me+=W,x[_+F]=-W,y[Se++]=F,x[C+F]!==-1&&(I[x[C+F]]=I[F]),I[F]!==-1?x[C+I[F]]=x[C+F]:x[E+x[M+F]]=x[C+F]);z!==q&&(D[z]=Mr(q),x[L+z]=0)}for(De!==0&&(w=Se),x[M+q]=Me,D[q]=ye,x[A+q]=Se-ye,x[T+q]=-2,N=c(N,m,x,L,v),re=ye;re<Se;re++)if(F=y[re],!((ne=x[T+F])<=0)){W=-x[_+F];var Ve=N-W;for(fe=D[F],Q=D[F]+ne-1;fe<=Q;fe++)z=y[fe],x[L+z]>=N?x[L+z]-=W:x[L+z]!==0&&(x[L+z]=x[M+z]+Ve)}for(re=ye;re<Se;re++){for(F=y[re],Q=D[F],ge=Q+x[T+F]-1,pe=Q,ae=0,ue=0,fe=Q;fe<=ge;fe++)if(z=y[fe],x[L+z]!==0){var Ue=x[L+z]-N;Ue>0?(ue+=Ue,y[pe++]=z,ae+=z):(D[z]=Mr(q),x[L+z]=0)}x[T+F]=pe-Q+1;var fr=pe,gr=Q+x[A+F];for(fe=ge+1;fe<gr;fe++){B=y[fe];var er=x[_+B];er<=0||(ue+=er,y[pe++]=B,ae+=B)}ue===0?(D[F]=Mr(q),W=-x[_+F],Me-=W,be+=W,X+=W,x[_+F]=0,x[T+F]=-1):(x[M+F]=Math.min(x[M+F],ue),y[pe]=y[fr],y[fr]=y[Q],y[Q]=q,x[A+F]=pe-Q+1,ae=(ae<0?-ae:ae)%v,x[C+F]=x[O+ae],x[O+ae]=F,I[F]=ae)}for(x[M+q]=Me,m=Math.max(m,Me),N=c(N+m,m,x,L,v),re=ye;re<Se;re++)if(F=y[re],!(x[_+F]>=0))for(ae=I[F],F=x[O+ae],x[O+ae]=-1;F!==-1&&x[C+F]!==-1;F=x[C+F],N++){for(G=x[A+F],ne=x[T+F],fe=D[F]+1;fe<=D[F]+G-1;fe++)x[L+y[fe]]=N;var Sr=F;for(B=x[C+F];B!==-1;){var Pr=x[A+B]===G&&x[T+B]===ne;for(fe=D[B]+1;Pr&&fe<=D[B]+G-1;fe++)x[L+y[fe]]!==N&&(Pr=0);Pr?(D[B]=Mr(F),x[_+F]+=x[_+B],x[_+B]=0,x[T+B]=-1,B=x[C+B],x[C+Sr]=B):(Sr=B,B=x[C+B])}}for(fe=ye,re=ye;re<Se;re++)F=y[re],!((W=-x[_+F])<=0)&&(x[_+F]=W,ue=x[M+F]+Me-W,ue=Math.min(ue,v-X-W),x[E+ue]!==-1&&(I[x[E+ue]]=F),x[C+F]=x[E+ue],I[F]=-1,x[E+ue]=F,V=Math.min(V,ue),x[M+F]=ue,y[fe++]=F);x[_+q]=be,(x[A+q]=fe-ye)===0&&(D[q]=-1,x[L+q]=0),De!==0&&(w=fe)}for(F=0;F<v;F++)D[F]=Mr(D[F]);for(B=0;B<=v;B++)x[E+B]=-1;for(B=v;B>=0;B--)x[_+B]>0||(x[C+B]=x[E+D[B]],x[E+D[B]]=B);for(z=v;z>=0;z--)x[_+z]<=0||D[z]!==-1&&(x[C+z]=x[E+D[z]],x[E+D[z]]=z);for(q=0,F=0;F<=v;F++)D[F]===-1&&(q=On(F,q,x,E,C,b,L));return b.splice(b.length-1,1),b};function i(u,o,s,p,h){var v=t(o);if(u===1&&p===s)return e(o,v);if(u===2){for(var m=v._index,d=v._ptr,g=0,y=0;y<s;y++){var D=d[y];if(d[y]=g,!(d[y+1]-D>h))for(var w=d[y+1];D<w;D++)m[g++]=m[D]}return d[s]=g,o=t(v),r(v,o)}return r(v,o)}function a(u,o,s,p,h,v,m,d,g,y,D,w){for(var b=0;b<u;b++)s[p+b]=o[b+1]-o[b];s[p+u]=0;for(var x=0;x<=u;x++)s[h+x]=-1,v[x]=-1,s[m+x]=-1,s[d+x]=-1,s[g+x]=1,s[y+x]=1,s[D+x]=0,s[w+x]=s[p+x];var A=c(0,0,s,y,u);return s[D+u]=-2,o[u]=-1,s[y+u]=0,A}function l(u,o,s,p,h,v,m,d,g,y,D){for(var w=0,b=0;b<u;b++){var x=s[p+b];if(x===0)s[h+b]=-2,w++,o[b]=-1,s[v+b]=0;else if(x>m)s[d+b]=0,s[h+b]=-1,w++,o[b]=Mr(u),s[d+u]++;else{var A=s[g+x];A!==-1&&(y[A]=b),s[D+b]=s[g+x],s[g+x]=b}}return w}function c(u,o,s,p,h){if(u<2||u+o<0){for(var v=0;v<h;v++)s[p+v]!==0&&(s[p+v]=1);u=2}return u}function f(u,o){return u!==o}});function Ds(n,e,r,t,i,a,l){var c,f,u=0,o;if(n<=e||r[t+e]<=r[i+n])return-1;r[i+n]=r[t+e];var s=r[a+n];if(r[a+n]=e,s===-1)u=1,o=n;else{for(u=2,o=s;o!==r[l+o];o=r[l+o]);for(c=s;c!==o;c=f)f=r[l+c],r[l+c]=o}return{jleaf:u,q:o}}var pm="csCounts",mm=["transpose"],ys=P(pm,mm,n=>{var{transpose:e}=n;return function(r,t,i,a){if(!r||!t||!i)return null;var l=r._size,c=l[0],f=l[1],u,o,s,p,h,v,m,d=4*f+(a?f+c+1:0),g=[],y=0,D=f,w=2*f,b=3*f,x=4*f,A=5*f+1;for(s=0;s<d;s++)g[s]=-1;var _=[],C=e(r),E=C._index,T=C._ptr;for(s=0;s<f;s++)for(o=i[s],_[o]=g[b+o]===-1?1:0;o!==-1&&g[b+o]===-1;o=t[o])g[b+o]=s;if(a){for(s=0;s<f;s++)g[i[s]]=s;for(u=0;u<c;u++){for(s=f,v=T[u],m=T[u+1],h=v;h<m;h++)s=Math.min(s,g[E[h]]);g[A+u]=g[x+s],g[x+s]=u}}for(u=0;u<f;u++)g[y+u]=u;for(s=0;s<f;s++){for(o=i[s],t[o]!==-1&&_[t[o]]--,p=a?g[x+s]:o;p!==-1;p=a?g[A+p]:-1)for(h=T[p];h<T[p+1];h++){u=E[h];var M=Ds(u,o,g,b,D,w,y);M.jleaf>=1&&_[o]++,M.jleaf===2&&_[M.q]--}t[o]!==-1&&(g[y+o]=t[o])}for(o=0;o<f;o++)t[o]!==-1&&(_[t[o]]+=_[o]);return _}});var hm="csSqr",vm=["add","multiply","transpose"],Es=P(hm,vm,n=>{var{add:e,multiply:r,transpose:t}=n,i=gs({add:e,multiply:r,transpose:t}),a=ys({transpose:t});return function(f,u,o){var s=u._ptr,p=u._size,h=p[1],v,m={};if(m.q=i(f,u),f&&!m.q)return null;if(o){var d=f?hs(u,null,m.q,0):u;m.parent=ds(d,1);var g=vs(m.parent,h);if(m.cp=a(d,m.parent,g,1),d&&m.parent&&m.cp&&l(d,m))for(m.unz=0,v=0;v<h;v++)m.unz+=m.cp[v]}else m.unz=4*s[h]+h,m.lnz=m.unz;return m};function l(c,f){var u=c._ptr,o=c._index,s=c._size,p=s[0],h=s[1];f.pinv=[],f.leftmost=[];var v=f.parent,m=f.pinv,d=f.leftmost,g=[],y=0,D=p,w=p+h,b=p+2*h,x,A,_,C,E;for(A=0;A<h;A++)g[D+A]=-1,g[w+A]=-1,g[b+A]=0;for(x=0;x<p;x++)d[x]=-1;for(A=h-1;A>=0;A--)for(C=u[A],E=u[A+1],_=C;_<E;_++)d[o[_]]=A;for(x=p-1;x>=0;x--)m[x]=-1,A=d[x],A!==-1&&(g[b+A]++===0&&(g[w+A]=x),g[y+x]=g[D+A],g[D+A]=x);for(f.lnz=0,f.m2=p,A=0;A<h;A++)if(x=g[D+A],f.lnz++,x<0&&(x=f.m2++),m[x]=A,!(--b[A]<=0)){f.lnz+=g[b+A];var T=v[A];T!==-1&&(g[b+T]===0&&(g[w+T]=g[w+A]),g[y+g[w+A]]=g[D+T],g[D+T]=g[y+x],g[b+T]+=g[b+A])}for(x=0;x<p;x++)m[x]<0&&(m[x]=A++);return!0}});function qt(n,e){return n[e]<0}function Pn(n,e){n[e]=Mr(n[e])}function Oa(n){return n<0?Mr(n):n}function ws(n,e,r,t,i){var a=e._index,l=e._ptr,c=e._size,f=c[1],u,o,s,p=0;for(t[0]=n;p>=0;){n=t[p];var h=i?i[n]:n;qt(l,n)||(Pn(l,n),t[f+p]=h<0?0:Oa(l[h]));var v=1;for(o=t[f+p],s=h<0?0:Oa(l[h+1]);o<s;o++)if(u=a[o],!qt(l,u)){t[f+p]=o,t[++p]=u,v=0;break}v&&(p--,t[--r]=n)}return r}function bs(n,e,r,t,i){var a=n._ptr,l=n._size,c=e._index,f=e._ptr,u=l[1],o,s,p,h=u;for(s=f[r],p=f[r+1],o=s;o<p;o++){var v=c[o];qt(a,v)||(h=ws(v,n,h,t,i))}for(o=h;o<u;o++)Pn(a,t[o]);return h}var dm="csSpsolve",xm=["divideScalar","multiply","subtract"],As=P(dm,xm,n=>{var{divideScalar:e,multiply:r,subtract:t}=n;return function(a,l,c,f,u,o,s){var p=a._values,h=a._index,v=a._ptr,m=a._size,d=m[1],g=l._values,y=l._index,D=l._ptr,w,b,x,A,_=bs(a,l,c,f,o);for(w=_;w<d;w++)u[f[w]]=0;for(b=D[c],x=D[c+1],w=b;w<x;w++)u[y[w]]=g[w];for(var C=_;C<d;C++){var E=f[C],T=o?o[E]:E;if(!(T<0))for(b=v[T],x=v[T+1],u[E]=e(u[E],p[s?b:x-1]),w=s?b+1:b,A=s?x:x-1;w<A;w++){var M=h[w];u[M]=t(u[M],r(p[w],u[E]))}}return _}});var gm="csLu",Dm=["abs","divideScalar","multiply","subtract","larger","largerEq","SparseMatrix"],Cs=P(gm,Dm,n=>{var{abs:e,divideScalar:r,multiply:t,subtract:i,larger:a,largerEq:l,SparseMatrix:c}=n,f=As({divideScalar:r,multiply:t,subtract:i});return function(o,s,p){if(!o)return null;var h=o._size,v=h[1],m,d=100,g=100;s&&(m=s.q,d=s.lnz||d,g=s.unz||g);var y=[],D=[],w=[],b=new c({values:y,index:D,ptr:w,size:[v,v]}),x=[],A=[],_=[],C=new c({values:x,index:A,ptr:_,size:[v,v]}),E=[],T,M,L=[],O=[];for(T=0;T<v;T++)L[T]=0,E[T]=-1,w[T+1]=0;d=0,g=0;for(var I=0;I<v;I++){w[I]=d,_[I]=g;var N=m?m[I]:I,X=f(b,o,N,O,L,E,1),V=-1,F=-1;for(M=X;M<v;M++)if(T=O[M],E[T]<0){var B=e(L[T]);a(B,F)&&(F=B,V=T)}else A[g]=E[T],x[g++]=L[T];if(V===-1||F<=0)return null;E[N]<0&&l(e(L[N]),t(F,p))&&(V=N);var q=L[V];for(A[g]=I,x[g++]=q,E[V]=I,D[d]=V,y[d++]=1,M=X;M<v;M++)T=O[M],E[T]<0&&(D[d]=T,y[d++]=r(L[T],q)),L[T]=0}for(w[v]=d,_[v]=g,M=0;M<d;M++)D[M]=E[D[M]];return y.splice(d,y.length-d),D.splice(d,D.length-d),x.splice(g,x.length-g),A.splice(g,A.length-g),{L:b,U:C,pinv:E}}});var _s="slu",ym=["typed","abs","add","multiply","transpose","divideScalar","subtract","larger","largerEq","SparseMatrix"],Pa=P(_s,ym,n=>{var{typed:e,abs:r,add:t,multiply:i,transpose:a,divideScalar:l,subtract:c,larger:f,largerEq:u,SparseMatrix:o}=n,s=Es({add:t,multiply:i,transpose:a}),p=Cs({abs:r,divideScalar:l,multiply:i,subtract:c,larger:f,largerEq:u,SparseMatrix:o});return e(_s,{"SparseMatrix, number, number":function(v,m,d){if(!de(m)||m<0||m>3)throw new Error("Symbolic Ordering and Analysis order must be an integer number in the interval [0, 3]");if(d<0||d>1)throw new Error("Partial pivoting threshold must be a number from 0 to 1");var g=s(m,v,!1),y=p(v,g,d);return{L:y.L,U:y.U,p:y.pinv,q:g.q,toString:function(){return"L: "+this.L.toString()+`
U: `+this.U.toString()+`
p: `+this.p.toString()+(this.q?`
q: `+this.q.toString():"")+`
`}}}})});function za(n,e){var r,t=e.length,i=[];if(n)for(r=0;r<t;r++)i[n[r]]=e[r];else for(r=0;r<t;r++)i[r]=e[r];return i}var Ms="lusolve",Em=["typed","matrix","lup","slu","usolve","lsolve","DenseMatrix"],qa=P(Ms,Em,n=>{var{typed:e,matrix:r,lup:t,slu:i,usolve:a,lsolve:l,DenseMatrix:c}=n,f=Hr({DenseMatrix:c});return e(Ms,{"Array, Array | Matrix":function(p,h){p=r(p);var v=t(p),m=o(v.L,v.U,v.p,null,h);return m.valueOf()},"DenseMatrix, Array | Matrix":function(p,h){var v=t(p);return o(v.L,v.U,v.p,null,h)},"SparseMatrix, Array | Matrix":function(p,h){var v=t(p);return o(v.L,v.U,v.p,null,h)},"SparseMatrix, Array | Matrix, number, number":function(p,h,v,m){var d=i(p,v,m);return o(d.L,d.U,d.p,d.q,h)},"Object, Array | Matrix":function(p,h){return o(p.L,p.U,p.p,p.q,h)}});function u(s){if(we(s))return s;if(Te(s))return r(s);throw new TypeError("Invalid Matrix LU decomposition")}function o(s,p,h,v,m){s=u(s),p=u(p),h&&(m=f(s,m,!0),m._data=za(h,m._data));var d=l(s,m),g=a(p,d);return v&&(g._data=za(v,g._data)),g}});var Ts="det",wm=["typed","matrix","subtract","multiply","divideScalar","isZero","unaryMinus"],ka=P(Ts,wm,n=>{var{typed:e,matrix:r,subtract:t,multiply:i,divideScalar:a,isZero:l,unaryMinus:c}=n;return e(Ts,{any:function(o){return ve(o)},"Array | Matrix":function(o){var s;switch(we(o)?s=o.size():Array.isArray(o)?(o=r(o),s=o.size()):s=[],s.length){case 0:return ve(o);case 1:if(s[0]===1)return ve(o.valueOf()[0]);throw new RangeError("Matrix must be square (size: "+Fe(s)+")");case 2:{var p=s[0],h=s[1];if(p===h)return f(o.clone().valueOf(),p,h);throw new RangeError("Matrix must be square (size: "+Fe(s)+")")}default:throw new RangeError("Matrix must be two dimensional (size: "+Fe(s)+")")}}});function f(u,o,s){if(o===1)return ve(u[0][0]);if(o===2)return t(i(u[0][0],u[1][1]),i(u[1][0],u[0][1]));for(var p=!1,h=new Array(o).fill(0).map((A,_)=>_),v=0;v<o;v++){var m=h[v];if(l(u[m][v])){var d=void 0;for(d=v+1;d<o;d++)if(!l(u[h[d]][v])){m=h[d],h[d]=h[v],h[v]=m,p=!p;break}if(d===o)return u[m][v]}for(var g=u[m][v],y=v===0?1:u[h[v-1]][v-1],D=v+1;D<o;D++)for(var w=h[D],b=v+1;b<o;b++)u[w][b]=a(t(i(u[w][b],g),i(u[w][v],u[m][b])),y)}var x=u[h[o-1]][o-1];return p?c(x):x}});var Ss="inv",bm=["typed","matrix","divideScalar","addScalar","multiply","unaryMinus","det","identity","abs"],Va=P(Ss,bm,n=>{var{typed:e,matrix:r,divideScalar:t,addScalar:i,multiply:a,unaryMinus:l,det:c,identity:f,abs:u}=n;return e(Ss,{"Array | Matrix":function(p){var h=we(p)?p.size():Pe(p);switch(h.length){case 1:if(h[0]===1)return we(p)?r([t(1,p.valueOf()[0])]):[t(1,p[0])];throw new RangeError("Matrix must be square (size: "+Fe(h)+")");case 2:{var v=h[0],m=h[1];if(v===m)return we(p)?r(o(p.valueOf(),v,m),p.storage()):o(p,v,m);throw new RangeError("Matrix must be square (size: "+Fe(h)+")")}default:throw new RangeError("Matrix must be two dimensional (size: "+Fe(h)+")")}},any:function(p){return t(1,p)}});function o(s,p,h){var v,m,d,g,y;if(p===1){if(g=s[0][0],g===0)throw Error("Cannot calculate inverse, determinant is zero");return[[t(1,g)]]}else if(p===2){var D=c(s);if(D===0)throw Error("Cannot calculate inverse, determinant is zero");return[[t(s[1][1],D),t(l(s[0][1]),D)],[t(l(s[1][0]),D),t(s[0][0],D)]]}else{var w=s.concat();for(v=0;v<p;v++)w[v]=w[v].concat();for(var b=f(p).valueOf(),x=0;x<h;x++){var A=u(w[x][x]),_=x;for(v=x+1;v<p;)u(w[v][x])>A&&(A=u(w[v][x]),_=v),v++;if(A===0)throw Error("Cannot calculate inverse, determinant is zero");v=_,v!==x&&(y=w[x],w[x]=w[v],w[v]=y,y=b[x],b[x]=b[v],b[v]=y);var C=w[x],E=b[x];for(v=0;v<p;v++){var T=w[v],M=b[v];if(v!==x){if(T[x]!==0){for(d=t(l(T[x]),C[x]),m=x;m<h;m++)T[m]=i(T[m],a(d,C[m]));for(m=0;m<h;m++)M[m]=i(M[m],a(d,E[m]))}}else{for(d=C[x],m=x;m<h;m++)T[m]=t(T[m],d);for(m=0;m<h;m++)M[m]=t(M[m],d)}}}return b}}});function Ns(n){var{addScalar:e,subtract:r,flatten:t,multiply:i,multiplyScalar:a,divideScalar:l,sqrt:c,abs:f,bignumber:u,diag:o,inv:s,qr:p,usolve:h,usolveAll:v,equal:m,complex:d,larger:g,smaller:y,matrixFromColumns:D,dot:w}=n;function b(B,q,H,U,z){z===void 0&&(z=!0);var Z=x(B,q,H,U,z);A(B,q,H,U,z,Z);var{values:G,C:W}=_(B,q,H,U,z),re;return z&&(re=C(B,q,W,Z,G,H,U),re=D(...re)),{values:G,vectors:re}}function x(B,q,H,U,z){var Z=U==="BigNumber",G=U==="Complex",W=Z?u(0):0,re=Z?u(1):G?d(1):1,ne=Z?u(1):1,Q=Z?u(10):2,ge=a(Q,Q),pe;z&&(pe=Array(q).fill(re));for(var ae=!1;!ae;){ae=!0;for(var ue=0;ue<q;ue++){for(var De=W,be=W,Me=0;Me<q;Me++)if(ue!==Me){var fe=f(B[ue][Me]);De=e(De,fe),be=e(be,fe)}if(!m(De,0)&&!m(be,0)){for(var ye=ne,Se=De,Ve=l(be,Q),Ue=a(be,Q);y(Se,Ve);)Se=a(Se,ge),ye=a(ye,Q);for(;g(Se,Ue);)Se=l(Se,ge),ye=l(ye,Q);var fr=y(l(e(Se,be),ye),a(e(De,be),.95));if(fr){ae=!1;for(var gr=l(1,ye),er=0;er<q;er++)ue!==er&&(B[ue][er]=a(B[ue][er],ye),B[er][ue]=a(B[er][ue],gr));z&&(pe[ue]=a(pe[ue],ye))}}}}return o(pe)}function A(B,q,H,U,z,Z){var G=U==="BigNumber",W=U==="Complex",re=G?u(0):W?d(0):0;G&&(H=u(H));for(var ne=0;ne<q-2;ne++){for(var Q=0,ge=re,pe=ne+1;pe<q;pe++){var ae=B[pe][ne];y(f(ge),f(ae))&&(ge=ae,Q=pe)}if(!y(f(ge),H)){if(Q!==ne+1){var ue=B[Q];B[Q]=B[ne+1],B[ne+1]=ue;for(var De=0;De<q;De++){var be=B[De][Q];B[De][Q]=B[De][ne+1],B[De][ne+1]=be}if(z){var Me=Z[Q];Z[Q]=Z[ne+1],Z[ne+1]=Me}}for(var fe=ne+2;fe<q;fe++){var ye=l(B[fe][ne],ge);if(ye!==0){for(var Se=0;Se<q;Se++)B[fe][Se]=r(B[fe][Se],a(ye,B[ne+1][Se]));for(var Ve=0;Ve<q;Ve++)B[Ve][ne+1]=e(B[Ve][ne+1],a(ye,B[Ve][fe]));if(z)for(var Ue=0;Ue<q;Ue++)Z[fe][Ue]=r(Z[fe][Ue],a(ye,Z[ne+1][Ue]))}}}}return Z}function _(B,q,H,U,z){var Z=U==="BigNumber",G=U==="Complex",W=Z?u(1):G?d(1):1;Z&&(H=u(H));for(var re=ve(B),ne=[],Q=q,ge=[],pe=z?o(Array(q).fill(W)):void 0,ae=z?o(Array(Q).fill(W)):void 0,ue=0;ue<=100;){ue+=1;for(var De=0,be=0;be<Q;be++)re[be][be]=r(re[be][be],De);var{Q:Me,R:fe}=p(re);re=i(fe,Me);for(var ye=0;ye<Q;ye++)re[ye][ye]=e(re[ye][ye],De);if(z&&(ae=i(ae,Me)),Q===1||y(f(re[Q-1][Q-2]),H)){ue=0,ne.push(re[Q-1][Q-1]),z&&(ge.unshift([[1]]),M(ae,q),pe=i(pe,ae),Q>1&&(ae=o(Array(Q-1).fill(W)))),Q-=1,re.pop();for(var Se=0;Se<Q;Se++)re[Se].pop()}else if(Q===2||y(f(re[Q-2][Q-3]),H)){ue=0;var Ve=E(re[Q-2][Q-2],re[Q-2][Q-1],re[Q-1][Q-2],re[Q-1][Q-1]);ne.push(...Ve),z&&(ge.unshift(T(re[Q-2][Q-2],re[Q-2][Q-1],re[Q-1][Q-2],re[Q-1][Q-1],Ve[0],Ve[1],H,U)),M(ae,q),pe=i(pe,ae),Q>2&&(ae=o(Array(Q-2).fill(W)))),Q-=2,re.pop(),re.pop();for(var Ue=0;Ue<Q;Ue++)re[Ue].pop(),re[Ue].pop()}if(Q===0)break}if(ne.sort((er,Sr)=>+r(f(er),f(Sr))),ue>100){var fr=Error("The eigenvalues failed to converge. Only found these eigenvalues: "+ne.join(", "));throw fr.values=ne,fr.vectors=[],fr}var gr=z?i(pe,L(ge,q)):void 0;return{values:ne,C:gr}}function C(B,q,H,U,z,Z,G){var W=s(H),re=i(W,B,H),ne=G==="BigNumber",Q=G==="Complex",ge=ne?u(0):Q?d(0):0,pe=ne?u(1):Q?d(1):1,ae=[],ue=[];for(var De of z){var be=O(ae,De,m);be===-1?(ae.push(De),ue.push(1)):ue[be]+=1}for(var Me=[],fe=ae.length,ye=Array(q).fill(ge),Se=o(Array(q).fill(pe)),Ve=[],Ue=function(Sr){var Pr=ae[Sr],bt=r(re,i(Pr,Se)),zr=v(bt,ye);for(zr.shift();zr.length<ue[Sr];){var Qt=I(bt,q,zr,Z,G);if(Qt==null){Ve.push(Pr);break}zr.push(Qt)}var ei=i(s(U),H);zr=zr.map(at=>i(ei,at)),Me.push(...zr.map(at=>t(at)))},fr=0;fr<fe;fr++)Ue(fr);if(Ve.length!==0){var gr=new Error("Failed to find eigenvectors for the following eigenvalues: "+Ve.join(", "));throw gr.values=z,gr.vectors=Me,gr}return Me}function E(B,q,H,U){var z=e(B,U),Z=r(a(B,U),a(q,H)),G=a(z,.5),W=a(c(r(a(z,z),a(4,Z))),.5);return[e(G,W),r(G,W)]}function T(B,q,H,U,z,Z,G,W){var re=W==="BigNumber",ne=W==="Complex",Q=re?u(0):ne?d(0):0,ge=re?u(1):ne?d(1):1;if(y(f(H),G))return[[ge,Q],[Q,ge]];if(g(f(r(z,Z)),G))return[[r(z,U),r(Z,U)],[H,H]];var pe=r(B,z),ae=r(q,z),ue=r(H,z),De=r(U,z);return y(f(ae),G)?[[pe,ge],[ue,Q]]:[[ae,Q],[De,ge]]}function M(B,q){for(var H=0;H<B.length;H++)B[H].push(...Array(q-B[H].length).fill(0));for(var U=B.length;U<q;U++)B.push(Array(q).fill(0)),B[U][U]=1;return B}function L(B,q){for(var H=[],U=0;U<q;U++)H[U]=Array(q).fill(0);var z=0;for(var Z of B){for(var G=Z.length,W=0;W<G;W++)for(var re=0;re<G;re++)H[z+W][z+re]=Z[W][re];z+=G}return H}function O(B,q,H){for(var U=0;U<B.length;U++)if(H(B[U],q))return U;return-1}function I(B,q,H,U,z){for(var Z=z==="BigNumber"?u(1e3):1e3,G,W=0;G=N(q,H,z),G=h(B,G),!g(V(G),Z);)if(++W>=5)return null;for(W=0;;){var re=h(B,G);if(y(V(X(G,[re])),U))break;if(++W>=10)return null;G=F(re)}return G}function N(B,q,H){var U=H==="BigNumber",z=H==="Complex",Z=Array(B).fill(0).map(G=>2*Math.random()-1);return U&&(Z=Z.map(G=>u(G))),z&&(Z=Z.map(G=>d(G))),Z=X(Z,q),F(Z,H)}function X(B,q){for(var H of q)B=r(B,i(l(w(H,B),w(H,H)),H));return B}function V(B){return f(c(w(B,B)))}function F(B,q){var H=q==="BigNumber",U=q==="Complex",z=H?u(1):U?d(1):1;return i(l(z,V(B)),B)}return b}function Fs(n){var{config:e,addScalar:r,subtract:t,abs:i,atan:a,cos:l,sin:c,multiplyScalar:f,inv:u,bignumber:o,multiply:s,add:p}=n;function h(E,T){var M=arguments.length>2&&arguments[2]!==void 0?arguments[2]:e.epsilon,L=arguments.length>3?arguments[3]:void 0;if(L==="number")return v(E,M);if(L==="BigNumber")return m(E,M);throw TypeError("Unsupported data type: "+L)}function v(E,T){for(var M=E.length,L=Math.abs(T/M),O,I=new Array(M),N=0;N<M;N++)I[N]=C(M,0),I[N][N]=1;for(var X=x(E);Math.abs(X[1])>=Math.abs(L);){var V=X[0][0],F=X[0][1];O=d(E[V][V],E[F][F],E[V][F]),E=b(E,O,V,F),I=y(I,O,V,F),X=x(E)}for(var B=C(M,0),q=0;q<M;q++)B[q]=E[q][q];return _(ve(B),ve(I))}function m(E,T){for(var M=E.length,L=i(T/M),O,I=new Array(M),N=0;N<M;N++)I[N]=C(M,0),I[N][N]=1;for(var X=A(E);i(X[1])>=i(L);){var V=X[0][0],F=X[0][1];O=g(E[V][V],E[F][F],E[V][F]),E=w(E,O,V,F),I=D(I,O,V,F),X=A(E)}for(var B=C(M,0),q=0;q<M;q++)B[q]=E[q][q];return _(ve(B),ve(I))}function d(E,T,M){var L=T-E;return Math.abs(L)<=e.epsilon?Math.PI/4:.5*Math.atan(2*M/(T-E))}function g(E,T,M){var L=t(T,E);return i(L)<=e.epsilon?o(-1).acos().div(4):f(.5,a(s(2,M,u(L))))}function y(E,T,M,L){for(var O=E.length,I=Math.cos(T),N=Math.sin(T),X=C(O,0),V=C(O,0),F=0;F<O;F++)X[F]=I*E[F][M]-N*E[F][L],V[F]=N*E[F][M]+I*E[F][L];for(var B=0;B<O;B++)E[B][M]=X[B],E[B][L]=V[B];return E}function D(E,T,M,L){for(var O=E.length,I=l(T),N=c(T),X=C(O,o(0)),V=C(O,o(0)),F=0;F<O;F++)X[F]=t(f(I,E[F][M]),f(N,E[F][L])),V[F]=r(f(N,E[F][M]),f(I,E[F][L]));for(var B=0;B<O;B++)E[B][M]=X[B],E[B][L]=V[B];return E}function w(E,T,M,L){for(var O=E.length,I=o(l(T)),N=o(c(T)),X=f(I,I),V=f(N,N),F=C(O,o(0)),B=C(O,o(0)),q=s(o(2),I,N,E[M][L]),H=r(t(f(X,E[M][M]),q),f(V,E[L][L])),U=p(f(V,E[M][M]),q,f(X,E[L][L])),z=0;z<O;z++)F[z]=t(f(I,E[M][z]),f(N,E[L][z])),B[z]=r(f(N,E[M][z]),f(I,E[L][z]));E[M][M]=H,E[L][L]=U,E[M][L]=o(0),E[L][M]=o(0);for(var Z=0;Z<O;Z++)Z!==M&&Z!==L&&(E[M][Z]=F[Z],E[Z][M]=F[Z],E[L][Z]=B[Z],E[Z][L]=B[Z]);return E}function b(E,T,M,L){for(var O=E.length,I=Math.cos(T),N=Math.sin(T),X=I*I,V=N*N,F=C(O,0),B=C(O,0),q=X*E[M][M]-2*I*N*E[M][L]+V*E[L][L],H=V*E[M][M]+2*I*N*E[M][L]+X*E[L][L],U=0;U<O;U++)F[U]=I*E[M][U]-N*E[L][U],B[U]=N*E[M][U]+I*E[L][U];E[M][M]=q,E[L][L]=H,E[M][L]=0,E[L][M]=0;for(var z=0;z<O;z++)z!==M&&z!==L&&(E[M][z]=F[z],E[z][M]=F[z],E[L][z]=B[z],E[z][L]=B[z]);return E}function x(E){for(var T=E.length,M=0,L=[0,1],O=0;O<T;O++)for(var I=O+1;I<T;I++)Math.abs(M)<Math.abs(E[O][I])&&(M=Math.abs(E[O][I]),L=[O,I]);return[L,M]}function A(E){for(var T=E.length,M=0,L=[0,1],O=0;O<T;O++)for(var I=O+1;I<T;I++)i(M)<i(E[O][I])&&(M=i(E[O][I]),L=[O,I]);return[L,M]}function _(E,T){for(var M=E.length,L=Array(M),O=Array(M),I=0;I<M;I++)O[I]=Array(M);for(var N=0;N<M;N++){for(var X=0,V=E[0],F=0;F<E.length;F++)i(E[F])<i(V)&&(X=F,V=E[X]);L[N]=E.splice(X,1)[0];for(var B=0;B<M;B++)O[B][N]=T[B][X],T[B].splice(X,1)}return{values:L,vectors:O}}function C(E,T){for(var M=new Array(E),L=0;L<E;L++)M[L]=T;return M}return h}var Am="eigs",Cm=["config","typed","matrix","addScalar","equal","subtract","abs","atan","cos","sin","multiplyScalar","divideScalar","inv","bignumber","multiply","add","larger","column","flatten","number","complex","sqrt","diag","qr","usolve","usolveAll","im","re","smaller","matrixFromColumns","dot"],Ua=P(Am,Cm,n=>{var{config:e,typed:r,matrix:t,addScalar:i,subtract:a,equal:l,abs:c,atan:f,cos:u,sin:o,multiplyScalar:s,divideScalar:p,inv:h,bignumber:v,multiply:m,add:d,larger:g,column:y,flatten:D,number:w,complex:b,sqrt:x,diag:A,qr:_,usolve:C,usolveAll:E,im:T,re:M,smaller:L,matrixFromColumns:O,dot:I}=n,N=Fs({config:e,addScalar:i,subtract:a,column:y,flatten:D,equal:l,abs:c,atan:f,cos:u,sin:o,multiplyScalar:s,inv:h,bignumber:v,complex:b,multiply:m,add:d}),X=Ns({config:e,addScalar:i,subtract:a,multiply:m,multiplyScalar:s,flatten:D,divideScalar:p,sqrt:x,abs:c,bignumber:v,diag:A,qr:_,inv:h,usolve:C,usolveAll:E,equal:l,complex:b,larger:g,smaller:L,matrixFromColumns:O,dot:I});return r("eigs",{Array:function(z){var Z=t(z);return V(Z)},"Array, number|BigNumber":function(z,Z){var G=t(z);return V(G,Z)},Matrix:function(z){var{values:Z,vectors:G}=V(z);return{values:t(Z),vectors:t(G)}},"Matrix, number|BigNumber":function(z,Z){var{values:G,vectors:W}=V(z,Z);return{values:t(G),vectors:t(W)}}});function V(U,z){z===void 0&&(z=e.epsilon);var Z=U.size();if(Z.length!==2||Z[0]!==Z[1])throw new RangeError("Matrix must be square (size: "+Fe(Z)+")");var G=U.toArray(),W=Z[0];if(B(G,W,z)&&(q(G,W),F(G,W,z))){var re=H(U,G,W);return N(G,W,z,re)}var ne=H(U,G,W);return X(G,W,z,ne)}function F(U,z,Z){for(var G=0;G<z;G++)for(var W=G;W<z;W++)if(g(v(c(a(U[G][W],U[W][G]))),Z))return!1;return!0}function B(U,z,Z){for(var G=0;G<z;G++)for(var W=0;W<z;W++)if(g(v(c(T(U[G][W]))),Z))return!1;return!0}function q(U,z){for(var Z=0;Z<z;Z++)for(var G=0;G<z;G++)U[Z][G]=M(U[Z][G])}function H(U,z,Z){var G=U.datatype();if(G==="number"||G==="BigNumber"||G==="Complex")return G;for(var W=!1,re=!1,ne=!1,Q=0;Q<Z;Q++)for(var ge=0;ge<Z;ge++){var pe=z[Q][ge];if(Be(pe)||Bt(pe))W=!0;else if(ze(pe))re=!0;else if(Ft(pe))ne=!0;else throw TypeError("Unsupported type in Matrix: "+He(pe))}if(re&&ne&&console.warn("Complex BigNumbers not supported, this operation will lose precission."),ne){for(var ae=0;ae<Z;ae++)for(var ue=0;ue<Z;ue++)z[ae][ue]=b(z[ae][ue]);return"Complex"}if(re){for(var De=0;De<Z;De++)for(var be=0;be<Z;be++)z[De][be]=v(z[De][be]);return"BigNumber"}if(W){for(var Me=0;Me<Z;Me++)for(var fe=0;fe<Z;fe++)z[Me][fe]=w(z[Me][fe]);return"number"}else throw TypeError("Matrix contains unsupported types only.")}});var _m="divide",Mm=["typed","matrix","multiply","equalScalar","divideScalar","inv"],Xa=P(_m,Mm,n=>{var{typed:e,matrix:r,multiply:t,equalScalar:i,divideScalar:a,inv:l}=n,c=Cn({typed:e,equalScalar:i}),f=xt({typed:e});return e("divide",an({"Array | Matrix, Array | Matrix":function(o,s){return t(o,l(s))},"DenseMatrix, any":function(o,s){return f(o,s,a,!1)},"SparseMatrix, any":function(o,s){return c(o,s,a,!1)},"Array, any":function(o,s){return f(r(o),s,a,!1).valueOf()},"any, Array | Matrix":function(o,s){return t(o,l(s))}},a.signatures))});var Bs="combinations",Tm=["typed"],Za=P(Bs,Tm,n=>{var{typed:e}=n;return e(Bs,{"number, number":Oi,"BigNumber, BigNumber":function(t,i){var a=t.constructor,l,c,f=t.minus(i),u=new a(1);if(!Is(t)||!Is(i))throw new TypeError("Positive integer value expected in function combinations");if(i.gt(t))throw new TypeError("k must be less than n in function combinations");if(l=u,i.lt(f))for(c=u;c.lte(f);c=c.plus(u))l=l.times(i.plus(c)).dividedBy(c);else for(c=u;c.lte(i);c=c.plus(u))l=l.times(f.plus(c)).dividedBy(c);return l}})});function Is(n){return n.isInteger()&&n.gte(0)}var kt=Ai({config:We}),zn=_i({});var Qa=Ti({});var Ga=Si({});var je=Ni({Matrix:Ga});var ce=di({BigNumber:kt,Complex:zn,DenseMatrix:je,Fraction:Qa});var qn=$i({typed:ce});var Xr=Ji({typed:ce});var Sm=Sa({typed:ce});var Ya=Ui({BigNumber:kt,typed:ce});var Rs=Za({typed:ce}),Vt=Xi({Complex:zn,typed:ce}),Ls=ra({typed:ce});var Tr=qi({config:We,typed:ce});var Nm=ta({typed:ce});var Os=zi({typed:ce});var Wr=Hi({typed:ce});var $a=Vi({typed:ce});var Fm=na({typed:ce});var Bm=Ki({BigNumber:kt,Fraction:Qa,complex:Vt,typed:ce}),Im=Fa({typed:ce}),Dt=ki({Matrix:Ga,equalScalar:Tr,typed:ce});var Rm=Na({typed:ce});var kn=ji({Complex:zn,config:We,typed:ce});var Ut=Yi({typed:ce});var Ps=Zi({Fraction:Qa,typed:ce});var Re=Qi({DenseMatrix:je,Matrix:Ga,SparseMatrix:Dt,typed:ce});var Ja=pa({bignumber:Ya,fraction:Ps,number:$a});var zs=fa({matrix:Re,config:We,typed:ce}),Xt=Da({DenseMatrix:je,config:We,matrix:Re,typed:ce});var br=ea({DenseMatrix:je,addScalar:Xr,equalScalar:Tr,matrix:Re,typed:ce,unaryMinus:Ut});var Ha=la({matrix:Re,typed:ce});var Wa=ca({BigNumber:kt,config:We,matrix:Re,typed:ce});var Lm=aa({DenseMatrix:je,SparseMatrix:Dt,matrix:Re,typed:ce}),Or=ma({numeric:Ja,typed:ce});var qs=ga({DenseMatrix:je,equalScalar:Tr,matrix:Re,typed:ce});var ks=oa({matrix:Re,typed:ce});var Vs=wa({DenseMatrix:je,config:We,matrix:Re,typed:ce});var Om=va({DenseMatrix:je,divideScalar:Or,equalScalar:Tr,matrix:Re,multiplyScalar:Wr,subtract:br,typed:ce}),Pm=Gi({flatten:ks,matrix:Re,size:zs,typed:ce}),Us=Aa({config:We,numeric:Ja,smaller:Xt,typed:ce});var zm=ya({DenseMatrix:je,config:We,matrix:Re,typed:ce});var Xs=da({DenseMatrix:je,divideScalar:Or,equalScalar:Tr,matrix:Re,multiplyScalar:Wr,subtract:br,typed:ce});var yt=Ba({DenseMatrix:je,SparseMatrix:Dt,addScalar:Xr,equalScalar:Tr,matrix:Re,typed:ce});var Zs=Ia({addScalar:Xr,conj:Ls,multiplyScalar:Wr,size:zs,typed:ce});var Ka=ua({BigNumber:kt,DenseMatrix:je,SparseMatrix:Dt,config:We,matrix:Re,typed:ce});var Et=Ea({DenseMatrix:je,config:We,matrix:Re,typed:ce});var Ar=Wi({addScalar:Xr,dot:Zs,equalScalar:Tr,matrix:Re,multiplyScalar:Wr,typed:ce}),qm=La({addScalar:Xr,complex:Vt,conj:Ls,divideScalar:Or,equal:qs,identity:Ka,isZero:Os,matrix:Re,multiplyScalar:Wr,sign:Bm,sqrt:kn,subtract:br,typed:ce,unaryMinus:Ut,zeros:Wa}),km=sa({bignumber:Ya,matrix:Re,config:We,larger:Et,largerEq:Vs,smaller:Xt,smallerEq:zm,typed:ce});var Vm=Pa({SparseMatrix:Dt,abs:qn,add:yt,divideScalar:Or,larger:Et,largerEq:Vs,multiply:Ar,subtract:br,transpose:Ha,typed:ce});var Um=xa({DenseMatrix:je,divideScalar:Or,equalScalar:Tr,matrix:Re,multiplyScalar:Wr,subtract:br,typed:ce});var Vn=ka({divideScalar:Or,isZero:Os,matrix:Re,multiply:Ar,subtract:br,typed:ce,unaryMinus:Ut});var Xm=Ma({larger:Et,smaller:Xt});var Zm=Ca({DenseMatrix:je,smaller:Xt}),Qm=_a({ImmutableDenseMatrix:Zm});var Qs=ba({config:We,larger:Et,numeric:Ja,typed:ce});var Gm=ia({Index:Qm,matrix:Re,range:km,typed:ce});var Zt=Va({abs:qn,addScalar:Xr,det:Vn,divideScalar:Or,identity:Ka,matrix:Re,multiply:Ar,typed:ce,unaryMinus:Ut});var Un=ha({Complex:zn,config:We,fraction:Ps,identity:Ka,inv:Zt,matrix:Re,multiply:Ar,number:$a,typed:ce});var Ym=Ta({FibonacciHeap:Xm,addScalar:Xr,equalScalar:Tr});var Gs=Xa({divideScalar:Or,equalScalar:Tr,inv:Zt,matrix:Re,multiply:Ar,typed:ce});var $m=Ra({DenseMatrix:je,Spa:Ym,SparseMatrix:Dt,abs:qn,addScalar:Xr,divideScalar:Or,equalScalar:Tr,larger:Et,matrix:Re,multiplyScalar:Wr,subtract:br,typed:ce,unaryMinus:Ut});var Ys=Ua({abs:qn,add:yt,addScalar:Xr,atan:Sm,bignumber:Ya,column:Gm,complex:Vt,config:We,cos:Rm,diag:Lm,divideScalar:Or,dot:Zs,equal:qs,flatten:ks,im:Nm,inv:Zt,larger:Et,matrix:Re,matrixFromColumns:Pm,multiply:Ar,multiplyScalar:Wr,number:$a,qr:qm,re:Fm,sin:Im,smaller:Xt,sqrt:kn,subtract:br,typed:ce,usolve:Xs,usolveAll:Um});var $s=qa({DenseMatrix:je,lsolve:Om,lup:$m,matrix:Re,slu:Vm,typed:ce,usolve:Xs});var Ee=class{constructor(e,r){this.rows=1;this.cols=1;this.values=[];this.rows=e,this.cols=r,this.values=new Array(e*r).fill(0)}getRows(){return this.rows}getCols(){return this.cols}setValue(e,r,t){this.values[e*this.cols+r]=t}getValue(e,r){return this.values[e*this.cols+r]}getCol(e){let r=new ke(this.rows);for(let t=0;t<this.rows;t++)r.setValue(t,this.getValue(t,e));return r}clone(){let e=new Ee(this.rows,this.cols);return e.values=[...this.values],e}toString(){let e="[";for(let r=0;r<this.rows;r++){r>0&&(e+=","),e+="[";for(let t=0;t<this.cols;t++)t>0&&(e+=","),e+=this.getValue(r,t);e+="]"}return e+="]",e}static equal(e,r,t=1e-9){if(e.getRows()!=r.getRows()||e.getCols()!=r.getCols())return!1;let i=e.getRows(),a=e.getCols();for(let l=0;l<i;l++)for(let c=0;c<a;c++)if(Math.abs(e.getValue(l,c)-r.getValue(l,c))>t)return!1;return!0}floor(){let e=this.getRows(),r=this.getCols();for(let t=0;t<e;t++)for(let i=0;i<r;i++)this.setValue(t,i,Math.floor(this.getValue(t,i)))}ceil(){let e=this.getRows(),r=this.getCols();for(let t=0;t<e;t++)for(let i=0;i<r;i++)this.setValue(t,i,Math.ceil(this.getValue(t,i)))}round(){let e=this.getRows(),r=this.getCols();for(let t=0;t<e;t++)for(let i=0;i<r;i++)this.setValue(t,i,Math.round(this.getValue(t,i)))}static mod(e,r){let t=e.clone(),i=t.getRows(),a=t.getCols();for(let l=0;l<i;l++)for(let c=0;c<a;c++)t.setValue(l,c,t.getValue(l,c)%r);return t}static mathjs2matrix(e){let r=new Ee(e.size()[0],e.size()[1]),t=r.getRows(),i=r.getCols();for(let a=0;a<t;a++)for(let l=0;l<i;l++)r.setValue(a,l,e.get([a,l]));return r}static matrix2mathjs(e){let r=Wa(e.rows,e.cols);for(let t=0;t<e.rows;t++)for(let i=0;i<e.cols;i++)r.set([t,i],e.getValue(t,i));return r}is_zero(e=1e-9){for(let r=0;r<this.rows;r++)for(let t=0;t<this.cols;t++)if(Math.abs(this.getValue(r,t))>e)return!1;return!0}is_integer(){for(let e=0;e<this.rows;e++)for(let r=0;r<this.cols;r++){let t=this.getValue(e,r);if(Math.abs(t-Math.round(t))!=0)return!1}return!0}is_symmetric(){if(this.rows!=this.cols)return!1;for(let e=0;e<this.rows;e++)for(let r=0;r<this.cols;r++)if(this.getValue(e,r)!=this.getValue(r,e))return!1;return!0}rank(e=1e-12){let r=this.clone(),t=r.rows,i=r.cols,a=0,l=[];for(let c=0;c<i;c++)l.push(!1);for(let c=0;c<t;c++){let f;for(f=0;f<i&&!(!l[f]&&Math.abs(r.getValue(c,f))>e);f++);if(f!=i){a++,l[f]=!0;for(let u=c+1;u<t;u++)r.setValue(u,f,r.getValue(u,f)/r.getValue(c,f));for(let u=0;u<i;u++)if(u!=f&&Math.abs(r.getValue(c,u))>e)for(let o=c+1;o<t;o++)r.setValue(o,u,r.getValue(o,u)-r.getValue(o,f)*r.getValue(c,u))}}return a}};var Zn=class{constructor(e=[]){this.elements=[];this.elements=e}add(e){this.elements.includes(e)==!1&&this.elements.push(e)}min(){let e=1/0;for(let r of this.elements)r<e&&(e=r);return e}max(){let e=-1/0;for(let r of this.elements)r>e&&(e=r);return e}toString(){let e="{";return e+=this.elements.sort().join(","),e+="}",e}},wt=class{constructor(e=[]){this.elements=[];this.elements=e}add(e){this.elements.includes(e)==!1&&this.elements.push(e)}min(){let e=1/0;for(let r of this.elements)r<e&&(e=r);return e}max(){let e=-1/0;for(let r of this.elements)r>e&&(e=r);return e}toString(){let e="{";return e+=this.elements.sort().join(","),e+="}",e}},Qn=class{constructor(e=[]){this.elements=[];this.elements=e}add(e){this.elements.push(e)}toString(){let e="{";return e+=this.elements.join(","),e+="}",e}};var Gn=class{constructor(e){this.parent=null;this.parent=e}_create(e,r,t){let i=new Ee(e,r),a=0;for(let l=0;l<e;l++)for(let c=0;c<r;c++)i.setValue(l,c,t[a++]);return i}_clone(e){return e.clone()}_equalMatrices(e,r){return Ee.equal(e,r)}_unequalMatrices(e,r){return Ee.equal(e,r)==!1}_getElement(e,r,t,i){if(r<0||r>=e.getRows())throw new Ne(i,"matrix has "+e.getRows()+" rows. Cannot get row "+r);if(t<0||t>=e.getCols())throw new Ne(i,"matrix has "+e.getCols()+" columns. Cannot get column "+t);return e.getValue(r,t)}_setElement(e,r,t,i,a){if(r<0||r>=e.getRows())throw new Ne(a,"matrix has "+e.getRows()+" rows. Cannot get row "+r);if(t<0||t>=e.getCols())throw new Ne(a,"matrix has "+e.getCols()+" columns. Cannot get column "+t);e.setValue(r,t,i)}_eye(e){let r=new Ee(e,e);for(let t=0;t<e;t++)r.setValue(t,t,1);return r}_addMatrices(e,r,t){let i;try{i=yt(Ee.matrix2mathjs(e),Ee.matrix2mathjs(r))}catch{throw new Ne(t,"dimensions do not match")}return Ee.mathjs2matrix(i)}_subMatrices(e,r,t){let i;try{i=br(Ee.matrix2mathjs(e),Ee.matrix2mathjs(r))}catch{throw new Ne(t,"dimensions do not match")}return Ee.mathjs2matrix(i)}_mulScalarMatrix(e,r){let t=Ar(e,Ee.matrix2mathjs(r));return Ee.mathjs2matrix(t)}_mulMatrixScalar(e,r){let t=Ar(Ee.matrix2mathjs(e),r);return Ee.mathjs2matrix(t)}_mulMatrices(e,r,t){let i;try{i=Ar(Ee.matrix2mathjs(e),Ee.matrix2mathjs(r))}catch{throw new Ne(t,"dimensions do not match")}return Ee.mathjs2matrix(i)}_randMatrix(e,r,t,i){let a=new Ee(e,r);for(let l=0;l<e;l++)for(let c=0;c<r;c++)a.setValue(l,c,this.parent.interpret_basic._randIntMinMax(t,i));return a}_randZMatrix(e,r,t,i){let a=new Ee(e,r);for(let l=0;l<e;l++)for(let c=0;c<r;c++)a.setValue(l,c,this.parent.interpret_basic._randIntMinMaxZ(t,i));return a}_det(e,r){try{return Vn(Ee.matrix2mathjs(e))}catch{throw new Ne(r,"matrix is not square")}}_minMatrix(e){return Us(Ee.matrix2mathjs(e))}_maxMatrix(e){return Qs(Ee.matrix2mathjs(e))}_zeros(e,r){let t=new Ee(e,r);for(let i=0;i<e;i++)for(let a=0;a<r;a++)t.setValue(i,a,0);return t}_ones(e,r){let t=new Ee(e,r);for(let i=0;i<e;i++)for(let a=0;a<r;a++)t.setValue(i,a,1);return t}_floorMatrix(e){let r=e.clone();return r.floor(),r}_ceilMatrix(e){let r=e.clone();return r.ceil(),r}_roundMatrix(e){let r=e.clone();return r.round(),r}_transposeMatrix(e){return Ee.mathjs2matrix(Ha(Ee.matrix2mathjs(e)))}_triu(e){let r=e.clone();for(let t=0;t<r.getRows();t++)for(let i=0;i<r.getCols();i++)t>i&&r.setValue(t,i,0);return r}_linsolve(e,r){return Ee.mathjs2matrix($s(Ee.matrix2mathjs(e),ke.vector2list(r))).getCol(0)}_matrixFromVectors(e,r){let t=e.length;if(t==0)throw new Ne(r,"no vector given");let i=-1;for(let l=0;l<t;l++)if(l==0)i=e[0].getSize();else if(e[l].getSize()!=i)throw new Ne(r,"vector lengths differ");let a=new Ee(i,t);for(let l=0;l<i;l++)for(let c=0;c<t;c++)a.setValue(l,c,e[c].getValue(l));return a}_rank(e){return e.rank()}_isMatrixZero(e){return e.is_zero(1e-9)}_isMatrixSymmetric(e,r){if(e.getRows()!=e.getCols())throw new Ne(r,"matrix is not symmetric");return e.is_symmetric()}_isMatrixInvertible(e,r){if(e.getRows()!=e.getCols())throw new Ne(r,"matrix is not symmetric");let t=Vn(Ee.matrix2mathjs(e));return Math.abs(t)>1e-9}_invMatrix(e,r){if(this._isMatrixInvertible(e,r)==!1)throw new Ne(r,"matrix is not invertible");return Ee.mathjs2matrix(Zt(Ee.matrix2mathjs(e)))}_modMatrix(e,r,t){if(e.is_integer()==!1)throw new Ne(t,"matrix is not integral");return Ee.mod(e,r)}_matrixColumn(e,r,t){if(r<0||r>=e.getCols())throw new Ne(t,"invalid column");let i=new ke(e.getRows());for(let a=0;a<e.getRows();a++)i.setValue(a,e.getValue(a,r));return i}_matrixRow(e,r,t){if(r<0||r>=e.getRows())throw new Ne(t,"invalid row");let i=new ke(e.getCols());for(let a=0;a<e.getCols();a++)i.setValue(a,e.getValue(r,a));return i}_eigenvaluesSym(e,r){if(e.getRows()!=e.getCols())throw new Ne(r,"matrix is not symmetric");let t=Ys(Ee.matrix2mathjs(e)).values._data,i=new wt;for(let a of t)i.add(a);return i}};var Ie=class{constructor(e=0,r=0){this.real=e,this.imag=r}clone(){return new Ie(this.real,this.imag)}mulReal(e){this.real*=e,this.imag*=e}static mathjs2complex(e){return new Ie(e.re,e.im)}static complex2mathjs(e){return Vt(e.real,e.imag)}toMathJs(){return Ie.complex2mathjs(this)}toString(){return this.imag>=0?this.real+"+"+this.imag+"i":this.real+"-"+-this.imag+"i"}};var Yn=class{constructor(e){this.parent=null;this.parent=e}_create(e,r){return new Ie(e,r)}_unaryMinusComplex(e){return new Ie(-e.real,-e.imag)}_addComplex(e,r){return Ie.mathjs2complex(yt(e.toMathJs(),r.toMathJs()))}_addNumberComplex(e,r){return new Ie(e+r.real,r.imag)}_addComplexNumber(e,r){return new Ie(e.real+r,e.imag)}_subComplex(e,r){return Ie.mathjs2complex(br(e.toMathJs(),r.toMathJs()))}_subNumberComplex(e,r){return new Ie(e-r.real,r.imag)}_subComplexNumber(e,r){return new Ie(e.real-r,e.imag)}_mulComplex(e,r){return Ie.mathjs2complex(Ar(e.toMathJs(),r.toMathJs()))}_divComplex(e,r){return Ie.mathjs2complex(Gs(e.toMathJs(),r.toMathJs()))}_mulNumberComplex(e,r){let t=r.clone();return t.mulReal(e),t}_mulComplexNumber(e,r){let t=e.clone();return t.mulReal(r),t}_powComplexComplex(e,r){return Ie.mathjs2complex(Un(Ie.complex2mathjs(e),Ie.complex2mathjs(r)))}_powComplexNumber(e,r){return Ie.mathjs2complex(Un(Ie.complex2mathjs(e),r))}_powNumberComplex(e,r){return Ie.mathjs2complex(Un(e,Ie.complex2mathjs(r)))}_conjComplex(e){return new Ie(e.real,-e.imag)}_complex(e,r){return new Ie(e,r)}_extractComplexReal(e){return e.real}_extractComplexImag(e){return e.imag}_sqrtC_number(e){return e>=0?new Ie(Math.sqrt(e),0):new Ie(0,Math.sqrt(e))}_sqrtC_complex(e){return Ie.mathjs2complex(kn(Ie.complex2mathjs(e)))}_absComplex(e){return Math.sqrt(e.real*e.real+e.imag*e.imag)}};var $n=class{constructor(e){this.parent=null;this.parent=e}_equalBooleans(e,r){return e==r}_equalNumbers(e,r){return Math.abs(e-r)<=1e-9}_unequalBooleans(e,r){return e!=r}_unequalNumbers(e,r){return Math.abs(e-r)>1e-9}_add(e,r){return e+r}_unaryMinus(e){return-e}_unaryNot(e){return!e}_sub(e,r){return e-r}_mul(e,r){return e*r}_div(e,r){return e/r}_mod(e,r){return e%r}_pow(e,r){return Math.pow(e,r)}_randIntMax(e){return Math.floor(Math.random()*e)}_randIntMaxZ(e){let r=0;for(;r==0;)r=this._randIntMax(e);return r}_randIntMinMax(e,r){return Math.floor(Math.random()*(r+1-e)+e)}_randIntMinMaxZ(e,r){let t=0;for(;t==0;)t=this._randIntMinMax(e,r);return t}_sin(e){return Math.sin(e)}_cos(e){return Math.cos(e)}_tan(e){return Math.tan(e)}_asin(e){return Math.asin(e)}_acos(e){return Math.acos(e)}_atan(e){return Math.atan(e)}_exp(e){return Math.exp(e)}_sqrt(e,r){if(e<0)throw new Ne(r,'parameter must be positive; otherwise use function "sqrtC"');return Math.sqrt(e)}_abs(e){return Math.abs(e)}_floor(e){return Math.floor(e)}_int2real(e){return e}_ceil(e){return Math.ceil(e)}_round(e){return Math.round(e)}_sign(e){return e==0?0:e<0?-1:1}_maxInt(e){return Math.max(...e)}_fac(e){let r=1;for(let t=1;t<=e;t++)r*=t;return r}_binomial(e,r){return Rs(e,r)}};var Kr=class extends Error{constructor(e){super(e),this.name="TermError"}},oe=class{constructor(e="",r=[]){this.op="";this.value="";this.o=[];this.op=e,this.o=r}static Op(e,r){let t=new oe;return t.op=e,t.o=r,t}static Const(e){let r=new oe;return r.op="#",r.value=e,r}static Var(e){let r=new oe;return r.op="$",r.value=e,r}clone(){let e=new oe;e.op=this.op,e.value=this.value;for(let r of this.o)e.o.push(r.clone());return e}eval(e={}){let r;switch(this.op){case"+":r=0;for(let t of this.o)r+=t.eval(e);break;case"*":r=1;for(let t of this.o)r*=t.eval(e);break;case"-":r=0;for(let t of this.o)r-=t.eval(e);break;case".-":r=-this.o[0].eval(e);break;case"^":r=Math.pow(this.o[0].eval(e),this.o[1].eval(e));break;case"#":r=this.value;break;case"sin":r=Math.sin(this.o[0].eval(e));break;case"cos":r=Math.cos(this.o[0].eval(e));break;case"tan":r=Math.tan(this.o[0].eval(e));break;case"asin":r=Math.asin(this.o[0].eval(e));break;case"atan":r=Math.atan(this.o[0].eval(e));break;case"exp":r=Math.exp(this.o[0].eval(e));break;case"$":if(this.value in e)return e[this.value];throw new Kr('eval(..): unset variable "'+this.value+'"');default:throw new Kr('eval(..): unimplemented operator "'+this.op+'"')}return r}diff(e){let r=null,t,i;switch(this.op){case"+":r=oe.Op("+",[]);for(let a of this.o)r.o.push(a.diff(e));break;case".-":r=oe.Op(".-",[this.o[0].diff(e)]);break;case"-":if(this.o.length>2)throw new Kr('diff(..): non-binary "-" operator is unimplemented');r=oe.Op("-",[this.o[0].diff(e),this.o[1].diff(e)]);break;case"*":t=this.o[0],i=this.o.length==2?this.o[1]:oe.Op("*",this.o.slice(1)),r=oe.Op("+",[oe.Op("*",[t.diff(e),i.clone()]),oe.Op("*",[t.clone(),i.diff(e)])]);break;case"/":if(this.o.length>2)throw new Kr('diff(..): non-binary "/" operator is unimplemented');r=oe.Op("/",[oe.Op("-",[oe.Op("*",[this.o[0].diff(e),this.o[1].clone()]),oe.Op("*",[this.o[0].clone(),this.o[1].diff(e)])]),oe.Op("^",[this.o[1].clone(),oe.Const(2)])]);break;case"^":if(this.o[1].op!=="#")throw new Kr("diff(..): u^v: operator ^ only implemented for constant v");r=oe.Op("*",[this.o[0].diff(e),this.o[1].clone(),oe.Op("^",[this.o[0].clone(),oe.Const(this.o[1].value-1)])]);break;case"exp":r=oe.Op("*",[this.o[0].diff(e),oe.Op("exp",[this.o[0].clone()])]);break;case"sin":r=oe.Op("*",[this.o[0].diff(e),oe.Op("cos",[this.o[0].clone()])]);break;case"cos":r=oe.Op(".-",[oe.Op("*",[this.o[0].diff(e),oe.Op("cos",[this.o[0].clone()])])]);break;case"$":r=oe.Const(this.value===e?1:0);break;case"#":r=oe.Const(0);break;default:throw new Kr('diff(..): unimplemented operator "'+this.op+'"')}return r}integrate(e,r,t,i=1e-12){let a=0;for(let l=r;l<=t;l+=i)a+=this.eval({varId:l});return a/i}optimize(){let e=this.clone();for(let r=0;r<e.o.length;r++)e.o[r]=e.o[r].optimize();if(this.op==="*"){for(let r of e.o)if(r.op==="#"&&r.value==0)return oe.Const(0)}try{let r=e.eval();return oe.Const(r)}catch{}return e}setVariableValue(e,r){this.op==="$"&&(this.op="#",this.value=r);for(let t of this.o)t.setVariableValue(e,r)}getVariableIDs(){let e=new Set;this.op==="$"&&e.add(this.value);for(let r of this.o)e=new Set([...e,...r.getVariableIDs()]);return e}toString(){let e="";switch(this.op){case"#":case"$":e=""+this.value;break;case".-":e+="-("+this.o[0].toString()+")";break;default:if(this.op.length>2){e+=this.op+"(";for(let r=0;r<this.o.length;r++)r>0&&(e+=","),e+=this.o[r].toString();e+=")"}else{e+="(";for(let r=0;r<this.o.length;r++)r>0&&(e+=this.op),e+=this.o[r].toString();e+=")"}break}return e}};var Jn=class{constructor(e){this.parent=null;this.parent=e}var(e){return oe.Var(e)}_eval(e,r,t){let i=0;try{i=e.eval(r)}catch(a){throw new Ne(t,a.message)}return i}_numberToTerm(e){return oe.Const(e)}_addTermReal(e,r){return oe.Op("+",[e,oe.Const(r)])}_addRealTerm(e,r){return oe.Op("+",[oe.Const(e),r])}_addTermTerm(e,r){return oe.Op("+",[e,r])}_subTermReal(e,r){return oe.Op("-",[e,oe.Const(r)])}_subRealTerm(e,r){return oe.Op("-",[oe.Const(e),r])}_subTermTerm(e,r){return oe.Op("-",[e,r])}_mulTermReal(e,r){return oe.Op("*",[e,oe.Const(r)])}_mulRealTerm(e,r){return oe.Op("*",[oe.Const(e),r])}_mulTermTerm(e,r){return oe.Op("*",[e,r])}_divTermReal(e,r){return oe.Op("/",[e,oe.Const(r)])}_divRealTerm(e,r){return oe.Op("/",[oe.Const(e),r])}_divTermTerm(e,r){return oe.Op("/",[e,r])}_unaryMinusTerm(e){return oe.Op(".-",[e])}_powTermReal(e,r){return oe.Op("^",[e,oe.Const(r)])}_powRealTerm(e,r){return oe.Op("^",[oe.Const(e),r])}_powTermTerm(e,r){return oe.Op("^",[e,r])}_sinTerm(e){return oe.Op("sin",[e])}_cosTerm(e){return oe.Op("cos",[e])}_tanTerm(e){return oe.Op("tan",[e])}_expTerm(e){return oe.Op("exp",[e])}_diffTerm(e,r){return e.diff(r.toString())}_ode(e,r){return oe.Op("ode",[e,r])}};var Hn=class{constructor(e){this.parent=null;this.parent=e}_createIntSet(e){let r=new Zn;for(let t of e)r.add(t);return r}_createRealSet(e){let r=new wt;for(let t of e)r.add(t);return r}_createComplexSet(e){let r=new Qn;for(let t of e)r.add(t);return r}_maxSetInt(e){return e.max()}_maxSetReal(e){return e.max()}_minSetInt(e){return e.min()}_minSetReal(e){return e.min()}_lenSet(e){return e.elements.length}_randIntSet(e){return e.elements[Math.floor(Math.random()*e.elements.length)]}};var Ne=class extends Error{constructor(e,r){super(""+e+":"+r),this.name="RunError"}},Wn=class{constructor(){this.interpret_vector=null;this.interpret_matrix=null;this.interpret_complex=null;this.interpret_basic=null;this.interpret_term=null;this.interpret_set=null;this.interpret_vector=new jt(this),this.interpret_matrix=new Gn(this),this.interpret_complex=new Yn(this),this.interpret_basic=new $n(this),this.interpret_term=new Jn(this),this.interpret_set=new Hn(this)}interpret(e,r){e+="return [";let t=0;for(let a of r)a.type.base!="TERM_VAR"&&(t>0&&(e+=", "),e+=a.id,t++);e+="];";let i=new Function("runtime",e);try{let a=i(this);for(let l=0;l<r.length;l++){let c=r[l];switch(c.type.base){case"BOOL":c.value=a[l];break;case"INT":case"REAL":c.value=a[l];break;case"COMPLEX":c.value=a[l];break;case"VECTOR":c.value=a[l];break;case"MATRIX":c.value=a[l];break;case"TERM":c.value=a[l];break;case"INT_SET":c.value=a[l];break;case"REAL_SET":c.value=a[l];break;case"COMPLEX_SET":c.value=a[l];break;default:throw new Ne("-1","interpret(..): unimplemented type "+c.type)}}}catch(a){throw new Ne("-1","interpret(..) failed: "+a)}}};var Hs=Mt(ni());var Js=`
