"use strict";var mathebuddySMPL=(()=>{var wu=Object.create;var xt=Object.defineProperty;var Au=Object.getOwnPropertyDescriptor;var Cu=Object.getOwnPropertyNames;var Tu=Object.getPrototypeOf,bu=Object.prototype.hasOwnProperty;var gr=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),Fu=(r,e)=>{for(var t in e)xt(r,t,{get:e[t],enumerable:!0})},_i=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Cu(e))!bu.call(r,i)&&i!==t&&xt(r,i,{get:()=>e[i],enumerable:!(n=Au(e,i))||n.enumerable});return r};var rt=(r,e,t)=>(t=r!=null?wu(Tu(r)):{},_i(e||!r||!r.__esModule?xt(t,"default",{value:r,enumerable:!0}):t,r)),_u=r=>_i(xt({},"__esModule",{value:!0}),r);var Ni=gr(nr=>{"use strict";Object.defineProperty(nr,"__esModule",{value:!0});nr.getStr=nr.setLanguage=nr.LanguageText=nr.Language=void 0;var gt;(function(r){r[r.EN=0]="EN",r[r.DE=1]="DE"})(gt=nr.Language||(nr.Language={}));var Je;(function(r){r[r.EXPECTED=0]="EXPECTED",r[r.EXPECTED_ONE_OF=1]="EXPECTED_ONE_OF",r[r.CONDITION_NOT_BOOLEAN=2]="CONDITION_NOT_BOOLEAN",r[r.UNKNOWN_SYMBOL=3]="UNKNOWN_SYMBOL",r[r.SYMBOL_IS_NOT_A_FUNCTION=4]="SYMBOL_IS_NOT_A_FUNCTION",r[r.BIN_OP_INCOMPATIBLE_TYPES=5]="BIN_OP_INCOMPATIBLE_TYPES"})(Je=nr.LanguageText||(nr.LanguageText={}));function Mu(r){Mi=r}nr.setLanguage=Mu;function Nu(r){return un[r+"_"+Mi]}nr.getStr=Nu;var Mi=gt.EN,un={};function Rr(r,e){un[r+"_"+gt.EN]=e}function Or(r,e){un[r+"_"+gt.DE]=e}Rr(Je.EXPECTED,"expected");Or(Je.EXPECTED,"erwarte");Rr(Je.EXPECTED_ONE_OF,"expected one of");Or(Je.EXPECTED_ONE_OF,"erwarte Token aus Liste");Rr(Je.CONDITION_NOT_BOOLEAN,"condition must be boolean");Or(Je.CONDITION_NOT_BOOLEAN,"Bedingung muss Boolsch sein");Rr(Je.UNKNOWN_SYMBOL,"unknown symbol");Or(Je.UNKNOWN_SYMBOL,"unbekanntes Symbol");Rr(Je.SYMBOL_IS_NOT_A_FUNCTION,"symbol is not a function");Or(Je.SYMBOL_IS_NOT_A_FUNCTION,"Symbol ist keine Funktion");Rr(Je.BIN_OP_INCOMPATIBLE_TYPES,"Operator $OP is incompatible for types $T1 and $T2");Or(Je.BIN_OP_INCOMPATIBLE_TYPES,"Operator $OP ist inkompatibel mit den Typen $T1 und $T2")});var Si=gr(Et=>{"use strict";Object.defineProperty(Et,"__esModule",{value:!0});Et.LexerState=void 0;var tt=class{constructor(){this.i=0,this.n=-1,this.row=1,this.col=1,this.indent=0,this.lastIndent=0,this.stack=[]}copy(){let e=new tt;e.i=this.i,e.n=this.n,e.row=this.row,e.col=this.col,e.indent=this.indent,e.lastIndent=this.lastIndent;for(let t=0;t<this.stack.length;t++)e.stack.push(this.stack[t].copy());return e}};Et.LexerState=tt});var Ii=gr(Nr=>{"use strict";Object.defineProperty(Nr,"__esModule",{value:!0});Nr.LexerToken=Nr.LexerTokenType=void 0;var Bi;(function(r){r.DEL="DEL",r.TER="TER",r.INT="INT",r.BIGINT="BIGINT",r.REAL="REAL",r.HEX="HEX",r.STR="STR",r.ID="ID",r.END="END"})(Bi=Nr.LexerTokenType||(Nr.LexerTokenType={}));var nt=class{constructor(){this.token="",this.type=Bi.TER,this.value=0,this.valueBigint=0n,this.fileID="",this.row=0,this.col=0}toString(){let e=this.token;e=e.replace(/\n/g,"\\n"),e=e.replace(/\t/g,"\\t");let t=this.fileID+":"+this.row+":"+this.col;return t+=': "'+e+'" ('+this.type+")",t}copy(){let e=new nt;return e.token=this.token,e.type=this.type,e.value=this.value,e.fileID=this.fileID,e.row=this.row,e.col=this.col,e}};Nr.LexerToken=nt});var Ri=gr(Er=>{"use strict";Object.defineProperty(Er,"__esModule",{value:!0});Er.Lexer=Er.ParseError=Er.LexerFile=void 0;var te=Ni(),Su=Si(),$=Ii(),yt=class{constructor(){this.stateBackup=null,this.tokenBackup=null,this.id="",this.sourceCode=""}};Er.LexerFile=yt;var _e=class extends Error{constructor(e){super(e),this.name="ParseError"}};Er.ParseError=_e;var sn=class{constructor(){this.terminals=new Set,this.fileStack=[],this.token=null,this.lastToken=null,this.state=null,this.singleLineCommentStart="//",this.multiLineCommentStart="/*",this.multilineCommentEnd="*/",this.emitNewline=!1,this.emitHex=!0,this.emitInt=!0,this.emitReal=!0,this.emitBigint=!0,this.emitDoubleQuotes=!0,this.emitIndentation=!1,this.lexerFilePositionPrefix="!>",this.allowBackslashLineBreaks=!1,this.putTrailingSemicolon=[],this.multicharDelimiters=[]}configureSingleLineComments(e="//"){this.singleLineCommentStart=e}configureMultiLineComments(e="/*",t="*/"){this.multiLineCommentStart=e,this.multilineCommentEnd=t}configureLexerFilePositionPrefix(e="!>"){this.lexerFilePositionPrefix=e}enableEmitNewlines(e){this.emitNewline=e}enableEmitHex(e){this.emitHex=e}enableEmitInt(e){this.emitInt=e}enableEmitReal(e){this.emitReal=e}enableEmitBigint(e){this.emitBigint=e}enableEmitDoubleQuotes(e){this.emitDoubleQuotes=e}enableEmitIndentation(e){this.emitIndentation=e}enableBackslashLineBreaks(e){this.allowBackslashLineBreaks=e}isEND(){return this.token.type===$.LexerTokenType.END}isNotEND(){return this.token.type!==$.LexerTokenType.END}END(){if(this.token.type===$.LexerTokenType.END)this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" END")}isID(){return this.token.type===$.LexerTokenType.ID}ID(){let e="";if(this.token.type===$.LexerTokenType.ID)e=this.token.token,this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" ID");return e}isLID(){return this.token.type===$.LexerTokenType.ID&&this.token.token===this.token.token.toLowerCase()}LID(){let e="";if(this.token.type===$.LexerTokenType.ID&&this.token.token===this.token.token.toLowerCase())e=this.token.token,this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" LowerCaseID");return e}isUID(){return this.token.type===$.LexerTokenType.ID&&this.token.token===this.token.token.toUpperCase()}UID(){let e="";if(this.token.type===$.LexerTokenType.ID&&this.token.token===this.token.token.toUpperCase())e=this.token.token,this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" UpperCaseID");return e}isINT(){return this.token.type===$.LexerTokenType.INT}INT(){let e=0;if(this.token.type===$.LexerTokenType.INT)e=this.token.value,this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" INT");return e}isBIGINT(){return this.token.type===$.LexerTokenType.BIGINT}BIGINT(){let e=0n;if(this.token.type===$.LexerTokenType.BIGINT)e=this.token.valueBigint,this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" BIGINT");return e}isREAL(){return this.token.type===$.LexerTokenType.REAL}REAL(){let e=0;if(this.token.type===$.LexerTokenType.REAL)e=this.token.value,this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" REAL");return e}isHEX(){return this.token.type===$.LexerTokenType.HEX}HEX(){let e="";if(this.token.type===$.LexerTokenType.HEX)e=this.token.token,this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" HEX");return e}isSTR(){return this.token.type===$.LexerTokenType.STR}STR(){let e="";if(this.token.type===$.LexerTokenType.STR)e=this.token.token,this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" STR");return e}isTER(e){return this.token.type===$.LexerTokenType.DEL&&this.token.token===e||this.token.type===$.LexerTokenType.ID&&this.token.token===e}isNotTER(e){return this.isTER(e)==!1&&this.token.type!=$.LexerTokenType.END}TER(e){if(this.token.type===$.LexerTokenType.DEL&&this.token.token===e||this.token.type===$.LexerTokenType.ID&&this.token.token===e)this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+' "'+e+'"')}isEOS(){return this.token.token===";"}EOS(){if(this.token.token===";")this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+' ";"')}isINDENT(){return this.token.type==$.LexerTokenType.DEL&&this.token.token==="	+"}isNotINDENT(){return!(this.token.type===$.LexerTokenType.DEL&&this.token.token==="	+")}INDENT(){if(this.token.type==$.LexerTokenType.DEL&&this.token.token==="	+")this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" INDENT")}isOUTDENT(){return this.token.type==$.LexerTokenType.DEL&&this.token.token==="	-"}isNotOUTDENT(){return this.token.type===$.LexerTokenType.END?!1:!(this.token.type===$.LexerTokenType.DEL&&this.token.token==="	-")}OUTDENT(){if(this.token.type==$.LexerTokenType.DEL&&this.token.token==="	-")this.next();else throw new _e(this.err_pos()+(0,te.getStr)(te.LanguageText.EXPECTED)+" OUTDENT")}isNEWLINE(){return this.isOUTDENT()||this.token.type==$.LexerTokenType.DEL&&this.token.token===`
