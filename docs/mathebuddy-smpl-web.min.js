"use strict";var mathebuddySMPL=(()=>{var Ns=Object.create;var Lt=Object.defineProperty;var Fs=Object.getOwnPropertyDescriptor;var Ss=Object.getOwnPropertyNames;var Is=Object.getPrototypeOf,Bs=Object.prototype.hasOwnProperty;var Nr=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Rs=(t,e)=>{for(var r in e)Lt(t,r,{get:e[r],enumerable:!0})},ga=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Ss(e))!Bs.call(t,i)&&i!==r&&Lt(t,i,{get:()=>e[i],enumerable:!(n=Fs(e,i))||n.enumerable});return t};var ht=(t,e,r)=>(r=t!=null?Ns(Is(t)):{},ga(e||!t||!t.__esModule?Lt(r,"default",{value:t,enumerable:!0}):r,t)),Ls=t=>ga(Lt({},"__esModule",{value:!0}),t);var Ea=Nr(pr=>{"use strict";Object.defineProperty(pr,"__esModule",{value:!0});pr.getStr=pr.setLanguage=pr.LanguageText=pr.Language=void 0;var Ot;(function(t){t[t.EN=0]="EN",t[t.DE=1]="DE"})(Ot=pr.Language||(pr.Language={}));var fr;(function(t){t[t.EXPECTED=0]="EXPECTED",t[t.EXPECTED_ONE_OF=1]="EXPECTED_ONE_OF",t[t.CONDITION_NOT_BOOLEAN=2]="CONDITION_NOT_BOOLEAN",t[t.UNKNOWN_SYMBOL=3]="UNKNOWN_SYMBOL",t[t.SYMBOL_IS_NOT_A_FUNCTION=4]="SYMBOL_IS_NOT_A_FUNCTION",t[t.BIN_OP_INCOMPATIBLE_TYPES=5]="BIN_OP_INCOMPATIBLE_TYPES"})(fr=pr.LanguageText||(pr.LanguageText={}));function Os(t){Da=t}pr.setLanguage=Os;function Ps(t){return Ln[t+"_"+Da]}pr.getStr=Ps;var Da=Ot.EN,Ln={};function $r(t,e){Ln[t+"_"+Ot.EN]=e}function Qr(t,e){Ln[t+"_"+Ot.DE]=e}$r(fr.EXPECTED,"expected");Qr(fr.EXPECTED,"erwarte");$r(fr.EXPECTED_ONE_OF,"expected one of");Qr(fr.EXPECTED_ONE_OF,"erwarte Token aus Liste");$r(fr.CONDITION_NOT_BOOLEAN,"condition must be boolean");Qr(fr.CONDITION_NOT_BOOLEAN,"Bedingung muss Boolsch sein");$r(fr.UNKNOWN_SYMBOL,"unknown symbol");Qr(fr.UNKNOWN_SYMBOL,"unbekanntes Symbol");$r(fr.SYMBOL_IS_NOT_A_FUNCTION,"symbol is not a function");Qr(fr.SYMBOL_IS_NOT_A_FUNCTION,"Symbol ist keine Funktion");$r(fr.BIN_OP_INCOMPATIBLE_TYPES,"Operator $OP is incompatible for types $T1 and $T2");Qr(fr.BIN_OP_INCOMPATIBLE_TYPES,"Operator $OP ist inkompatibel mit den Typen $T1 und $T2")});var ya=Nr(Pt=>{"use strict";Object.defineProperty(Pt,"__esModule",{value:!0});Pt.LexerState=void 0;var vt=class{constructor(){this.i=0,this.n=-1,this.row=1,this.col=1,this.indent=0,this.lastIndent=0,this.stack=[]}copy(){let e=new vt;e.i=this.i,e.n=this.n,e.row=this.row,e.col=this.col,e.indent=this.indent,e.lastIndent=this.lastIndent;for(let r=0;r<this.stack.length;r++)e.stack.push(this.stack[r].copy());return e}};Pt.LexerState=vt});var Ca=Nr(Vr=>{"use strict";Object.defineProperty(Vr,"__esModule",{value:!0});Vr.LexerToken=Vr.LexerTokenType=void 0;var wa;(function(t){t.DEL="DEL",t.TER="TER",t.INT="INT",t.BIGINT="BIGINT",t.REAL="REAL",t.HEX="HEX",t.STR="STR",t.ID="ID",t.END="END"})(wa=Vr.LexerTokenType||(Vr.LexerTokenType={}));var dt=class{constructor(){this.token="",this.type=wa.TER,this.value=0,this.valueBigint=0n,this.fileID="",this.row=0,this.col=0}toString(){let e=this.token;e=e.replace(/\n/g,"\\n"),e=e.replace(/\t/g,"\\t");let r=this.fileID+":"+this.row+":"+this.col;return r+=': "'+e+'" ('+this.type+")",r}copy(){let e=new dt;return e.token=this.token,e.type=this.type,e.value=this.value,e.fileID=this.fileID,e.row=this.row,e.col=this.col,e}};Vr.LexerToken=dt});var _a=Nr(Fr=>{"use strict";Object.defineProperty(Fr,"__esModule",{value:!0});Fr.Lexer=Fr.ParseError=Fr.LexerFile=void 0;var ce=Ea(),zs=ya(),W=Ca(),zt=class{constructor(){this.stateBackup=null,this.tokenBackup=null,this.id="",this.sourceCode=""}};Fr.LexerFile=zt;var ke=class extends Error{constructor(e){super(e),this.name="ParseError"}};Fr.ParseError=ke;var On=class{constructor(){this.terminals=new Set,this.fileStack=[],this.token=null,this.lastToken=null,this.state=null,this.singleLineCommentStart="//",this.multiLineCommentStart="/*",this.multilineCommentEnd="*/",this.emitNewline=!1,this.emitHex=!0,this.emitInt=!0,this.emitReal=!0,this.emitBigint=!0,this.emitDoubleQuotes=!0,this.emitIndentation=!1,this.lexerFilePositionPrefix="!>",this.allowBackslashLineBreaks=!1,this.putTrailingSemicolon=[],this.multicharDelimiters=[]}configureSingleLineComments(e="//"){this.singleLineCommentStart=e}configureMultiLineComments(e="/*",r="*/"){this.multiLineCommentStart=e,this.multilineCommentEnd=r}configureLexerFilePositionPrefix(e="!>"){this.lexerFilePositionPrefix=e}enableEmitNewlines(e){this.emitNewline=e}enableEmitHex(e){this.emitHex=e}enableEmitInt(e){this.emitInt=e}enableEmitReal(e){this.emitReal=e}enableEmitBigint(e){this.emitBigint=e}enableEmitDoubleQuotes(e){this.emitDoubleQuotes=e}enableEmitIndentation(e){this.emitIndentation=e}enableBackslashLineBreaks(e){this.allowBackslashLineBreaks=e}isEND(){return this.token.type===W.LexerTokenType.END}isNotEND(){return this.token.type!==W.LexerTokenType.END}END(){if(this.token.type===W.LexerTokenType.END)this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" END")}isID(){return this.token.type===W.LexerTokenType.ID}ID(){let e="";if(this.token.type===W.LexerTokenType.ID)e=this.token.token,this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" ID");return e}isLID(){return this.token.type===W.LexerTokenType.ID&&this.token.token===this.token.token.toLowerCase()}LID(){let e="";if(this.token.type===W.LexerTokenType.ID&&this.token.token===this.token.token.toLowerCase())e=this.token.token,this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" LowerCaseID");return e}isUID(){return this.token.type===W.LexerTokenType.ID&&this.token.token===this.token.token.toUpperCase()}UID(){let e="";if(this.token.type===W.LexerTokenType.ID&&this.token.token===this.token.token.toUpperCase())e=this.token.token,this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" UpperCaseID");return e}isINT(){return this.token.type===W.LexerTokenType.INT}INT(){let e=0;if(this.token.type===W.LexerTokenType.INT)e=this.token.value,this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" INT");return e}isBIGINT(){return this.token.type===W.LexerTokenType.BIGINT}BIGINT(){let e=0n;if(this.token.type===W.LexerTokenType.BIGINT)e=this.token.valueBigint,this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" BIGINT");return e}isREAL(){return this.token.type===W.LexerTokenType.REAL}REAL(){let e=0;if(this.token.type===W.LexerTokenType.REAL)e=this.token.value,this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" REAL");return e}isHEX(){return this.token.type===W.LexerTokenType.HEX}HEX(){let e="";if(this.token.type===W.LexerTokenType.HEX)e=this.token.token,this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" HEX");return e}isSTR(){return this.token.type===W.LexerTokenType.STR}STR(){let e="";if(this.token.type===W.LexerTokenType.STR)e=this.token.token,this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" STR");return e}isTER(e){return this.token.type===W.LexerTokenType.DEL&&this.token.token===e||this.token.type===W.LexerTokenType.ID&&this.token.token===e}isNotTER(e){return this.isTER(e)==!1&&this.token.type!=W.LexerTokenType.END}TER(e){if(this.token.type===W.LexerTokenType.DEL&&this.token.token===e||this.token.type===W.LexerTokenType.ID&&this.token.token===e)this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+' "'+e+'"')}isEOS(){return this.token.token===";"}EOS(){if(this.token.token===";")this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+' ";"')}isINDENT(){return this.token.type==W.LexerTokenType.DEL&&this.token.token==="	+"}isNotINDENT(){return!(this.token.type===W.LexerTokenType.DEL&&this.token.token==="	+")}INDENT(){if(this.token.type==W.LexerTokenType.DEL&&this.token.token==="	+")this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" INDENT")}isOUTDENT(){return this.token.type==W.LexerTokenType.DEL&&this.token.token==="	-"}isNotOUTDENT(){return this.token.type===W.LexerTokenType.END?!1:!(this.token.type===W.LexerTokenType.DEL&&this.token.token==="	-")}OUTDENT(){if(this.token.type==W.LexerTokenType.DEL&&this.token.token==="	-")this.next();else throw new ke(this.err_pos()+(0,ce.getStr)(ce.LanguageText.EXPECTED)+" OUTDENT")}isNEWLINE(){return this.isOUTDENT()||this.token.type==W.LexerTokenType.DEL&&this.token.token===`
